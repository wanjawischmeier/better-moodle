...
export class CourseFilter {
    ...
    public update(): void {
        ...
        console.log(`[PDF Search] Got ${allTags.length} tags from search engine`);
        ...
        this.container.innerHTML = '<small class="text-muted d-block mb-1"><strong>Filter by course:</strong></small>';
