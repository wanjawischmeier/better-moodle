/**
 * Background Script for Better-Moodle Firefox Extension
 *
 ...
 *
 * Note: Script injection is now handled by content-script-bridge.js to ensure
 * proper page context injection.
 */

console.log('[Better-Moodle Extension] Background script started');
...
async function handleXHRRequest(details, tabId) {
    const { requestId, method, url, headers, data, responseType, timeout } =
        details;
    ...
    try {
        ...
        // Note: We send responseText, not complex objects, as message passing
