...
// @require         https://unpkg.com/darkreader@4.9.119/darkreader.js#sha512=847e1dd053def49ec445b41a7afd8a4cb590fd27f159f63f824a1d053c51340e320d0440345b55a90cbaf5ec44d9c3857238f84ebfd51377443792d348bd5355
// @require         https://github.com/jxn-30/better-moodle/releases/download/2.6.6/better-moodle-uzl-polyfills.js
...
/*! Copyright © *****************************************************************************
 *                                                                                          *
 *   This is Better-Moodle; Version 2.6.6; Built for UzL (https://moodle.uni-luebeck.de).   *
 *   Copyright (c) 2023-2026 Jan (@jxn-30), Yorik (@YorikHansen) and contributors.          *
 *   All rights reserved.                                                                   *
    ...
    d$1.has(e) ||
      ...
      (t => {
        typeof GM_addStyle == 'function' ?
          GM_addStyle(t)
        : (document.head || document.documentElement).appendChild(document.createElement('style')).append(t);
      })(e));
  };
...
body.dir-ltr .better-moodle_src-style-__no-external-link-icon::after, body.dir-rtl .better-moodle_src-style-__no-external-link-icon::before {
  display: none !important;
}

.better-moodle_src-style-__awaits-dropdown::after {
  margin-left: 4px;
  width: 9px;
  font-size: 9px;
...
@media (prefers-reduced-motion: no-preference) {
  .better-moodle_src-style-__awaits-dropdown::after {
    animation: better-moodle_src-style-__fade 1s cubic-bezier(0.4, 0, 0.6, 1) infinite;
  }
}
@keyframes better-moodle_src-style-__fade {
  0% {
    opacity: 0.5;
  }
  50% {
...
.better-moodle_src-style-__awaits-dropdown .icon {
  opacity: 0.5;
}

#usernavigation > :not(.better-moodle_src-style-__navbar-item) {
  order: 0;
}
#usernavigation > :not(.better-moodle_src-style-__navbar-item).usermenu-container, #usernavigation > :not(.better-moodle_src-style-__navbar-item).editmode-switch-form, #usernavigation > :not(.better-moodle_src-style-__navbar-item).divider:has(+ .editmode-switch-form) {
  order: 1000;
}

@media (prefers-reduced-motion: no-preference) {
  .better-moodle_src-style-__shining {
    position: relative;
  ...
  .better-moodle_src-style-__shining {
    animation: better-moodle_src-style-__shining 5s ease-in-out;
  }
}
@keyframes better-moodle_src-style-__shining {
  0% {
...
.better-moodle_src-style-__sparkling::before {
  display: inline-block;
  content: " ";
  position: absolute;
  width: 10ch;
...
.better-moodle_src-style-__sparkling::before {
  animation: better-moodle_src-style-__sparkling 1s ease-in-out infinite alternate, better-moodle_src-style-__sparkling_positions 6s step-start infinite;
}
@keyframes better-moodle_src-style-__sparkling {
  0% {
    scale: 0;
  }
  10% {
...
@keyframes better-moodle_src-style-__sparkling_positions {
  0% {
    top: 4%;
    left: 14%;
  }
...
}#better-moodle_src-style-settings__open-settings-btn.loading {
  opacity: 0.5;
}
#better-moodle_src-style-settings__open-settings-btn .tooltip:has(.better-moodle_src-style-settings__new-setting-badge) {
  z-index: 1035;
  cursor: pointer;
}

.modal-content:has(#better-moodle_src-style-settings__settings-form) .modal-header {
  align-items: center;
}
.modal-content:has(#better-moodle_src-style-settings__settings-form) .modal-header h5 ~ :not(div:has(input)) {
  padding: 1rem;
  margin: -0.8rem -0.8rem -0.8rem 0;
}
.modal-content:has(#better-moodle_src-style-settings__settings-form) .modal-header h5 ~ :not(button.close) {
  font-size: small;
}
.modal-content:has(#better-moodle_src-style-settings__settings-form) .modal-header h5 ~ div:has(> input[type=search]) {
  padding: 0;
  margin-bottom: 0;
  position: relative;
}
.modal-content:has(#better-moodle_src-style-settings__settings-form) .modal-header h5 ~ div:has(> input[type=search]) i.fa-search {
  width: 1em;
  position: absolute;
  top: 0;
  height: 100%;
...
.modal-content:has(#better-moodle_src-style-settings__settings-form) .modal-header h5 ~ div:has(> input[type=search]) > input[type=search] {
  padding-left: 1.6em;
}
.modal-content:has(#better-moodle_src-style-settings__settings-form) .modal-header h5 ~ div:has(> input[type=search]) > input[type=search]:not(:focus) {
  background-color: transparent;
}
@media (max-width: 991.98px) {
  .modal-content:has(#better-moodle_src-style-settings__settings-form) .modal-header h5 {
    flex-basis: 100%;
    flex-shrink: 1;
  }
  .modal-content:has(#better-moodle_src-style-settings__settings-form) .modal-header h5 ~ div:has(input[type=search]):has(> input[type=search]:focus) {
    position: absolute;
    top: 0;
    left: 0;
    width: 100%;
  }
  .modal-content:has(#better-moodle_src-style-settings__settings-form) .modal-header h5 ~ div:has(input[type=search]):has(> input[type=search]:not(:focus)) {
    max-width: 2em;
  }
  .modal-content:has(#better-moodle_src-style-settings__settings-form) .modal-header h5 ~ div:has(input[type=search]):has(> input[type=search]:not(:focus))::before {
    margin-left: 0;
    width: calc(100% + 2px);
  }
  .modal-content:has(#better-moodle_src-style-settings__settings-form) .modal-header h5 ~ div:has(input[type=search]) > input[type=search]:not(:focus) {
...
.modal-content:has(#better-moodle_src-style-settings__settings-form) #better-moodle_src-style-settings__support-wrapper {
  top: 0.5rem;
  right: 0.5rem;
}
@media (max-width: 991.98px) {
  ...
  .modal-content:has(#better-moodle_src-style-settings__settings-form) #better-moodle_src-style-settings__support-wrapper > div > span {
...
.modal-content:has(#better-moodle_src-style-settings__settings-form) .fitem:has(input[disabled], select[disabled]) .col-form-label label {
  color: var(--gray);
}
.better-moodle_src-style-settings__hide-disabled-settings .modal-content:has(#better-moodle_src-style-settings__settings-form) .fitem:has(input[disabled], select[disabled]) {
  display: none;
}
.modal-content:has(#better-moodle_src-style-settings__settings-form) .fitem .better-moodle_src-style-settings__new-setting-badge {
  margin-right: 1ch;
}
.modal-content:has(#better-moodle_src-style-settings__settings-form) fieldset .ftoggler h3 .better-moodle_src-style-settings__new-setting-badge {
  margin-left: 1ch;
}
.modal-content:has(#better-moodle_src-style-settings__settings-form) fieldset:not(:has(.fcontainer .better-moodle_src-style-settings__new-setting-badge)) .ftoggler h3 .better-moodle_src-style-settings__new-setting-badge {
  display: none;
}
.modal-content:has(#better-moodle_src-style-settings__settings-form) .better-moodle_src-style-settings__hide-new-setting-badges .better-moodle_src-style-settings__new-setting-badge {
  display: none !important;
}
.better-moodle_src-style-settings__hide-fun-settings .modal-content:has(#better-moodle_src-style-settings__settings-form) .fitem[data-tags*=fun] {
  display: none;
}
.modal-content:has(#better-moodle_src-style-settings__settings-form) #better-moodle_src-style-settings__settings-footer-btns > :where(button, a) > span {
  font-size: 0;
}
@media (min-width: 992px) and (prefers-reduced-motion: no-preference) {
  ...
  .modal-content:has(#better-moodle_src-style-settings__settings-form) #better-moodle_src-style-settings__settings-footer-btns > :where(button, a):hover > span {
    font-size: unset;
  }
}
@media (hover: none) and (max-width: 991.98px) {
  .modal-content:has(#better-moodle_src-style-settings__settings-form) #better-moodle_src-style-settings__settings-footer-btns > :where(button, a) {
    width: 100%;
  }
}
@media (hover: none) {
...
}.better-moodle_src-style-settings-SliderSetting__slider-setting datalist[style*="--label-count"] {
  display: grid;
  grid-template-columns: repeat(var(--label-count), minmax(0, 1fr));
  text-align: center;
  margin: 0 calc(50% - 0.5 * (1 + 1 / (var(--label-count) - 1)) * (100% - 1em));
}
.better-moodle_src-style-settings-SliderSetting__slider-setting datalist[style*="--label-count"] > option {
  overflow: hidden;
  text-overflow: ellipsis;
}
.better-moodle_src-style-settings-SliderSetting__slider-setting datalist[style*="--label-count"] > option:first-child {
  text-align: left;
  padding-left: calc(50% - 4px);
}
.better-moodle_src-style-settings-SliderSetting__slider-setting datalist[style*="--label-count"] > option:last-child {
  text-align: right;
  padding-right: calc(50% - 4px);
}
.better-moodle_src-style-settings-SliderSetting__slider-setting datalist[style*="--label-count"] > option::after {
  content: "";
  position: absolute;
...
.better-moodle_src-style-settings-SliderSetting__slider-setting input[type=range] + output {
  position: absolute;
  text-align: center;
  white-space: nowrap;
  padding: 2px;
...
.better-moodle_src-style-settings-SliderSetting__slider-setting input:disabled[type=range] + output {
  background-color: color-mix(in srgb, var(--primary) 50%, transparent);
}.better-moodle_src-style-modal__modal-background-image {
  position: absolute;
  width: 90%;
  height: 90%;
  opacity: 0.1;
...
.better-moodle_src-style-modal__modal-trigger {
  cursor: pointer;
}#better-moodle_src-features-bookmarks-__dropdown .dropdown-menu {
  max-width: 400px;
  right: 0;
  left: auto;
}
#better-moodle_src-features-bookmarks-__dropdown .dropdown-menu:has(.dropdown-item:first-child:nth-last-child(3))::before {
  display: block;
  text-align: center;
...
#better-moodle_src-features-bookmarks-__dropdown .dropdown-menu .dropdown-item {
  min-width: 100%;
  width: fit-content;
}
@media (max-width: 575.98px) {
  #better-moodle_src-features-bookmarks-__dropdown {
    position: inherit;
  }
  #better-moodle_src-features-bookmarks-__dropdown .dropdown-menu {
    max-width: 100%;
...
.better-moodle_src-features-bookmarks-__form .fcontainer {
  display: grid;
...
@media (max-width: 575.98px) {
  ...
  .better-moodle_src-features-bookmarks-__form .fcontainer .btn-group {
    grid-column-start: 1;
    grid-column-end: 3;
  }
}
...
.better-moodle_src-features-bookmarks-__form .fcontainer .btn-group[data-index="0"] [data-action=up], .better-moodle_src-features-bookmarks-__form .fcontainer .btn-group:not(:has(~ .btn-group[data-index])) [data-action=down] {
  pointer-events: none;
  opacity: 0.5;
}
.better-moodle_src-features-bookmarks-__form.better-moodle_src-features-bookmarks-__edit-form .fcontainer {
  grid-template-columns: 1fr 2fr;
}/*! Sass Fairy v1 | (c) roydukkey | https://sass-fairy.com/license *//*! Sass Fairy v1 | (c) roydukkey | https://sass-fairy.com/license */
.better-moodle_src-style-marquee__marquee {
  --max-width: 0px;
  --text-width: 0;
  --text-speed: 100;
  --parent-left: 0px;
...
.better-moodle_src-style-marquee__marquee:not(:has(> span[data-rolling])) {
  justify-content: end;
}
.better-moodle_src-style-marquee__marquee:not(:has(> span[data-rolling])) > span > *:last-child::after {
  display: none;
}
.better-moodle_src-style-marquee__marquee > span {
  display: inline-block;
  white-space: nowrap;
  will-change: transform;
}
.better-moodle_src-style-marquee__marquee > span > *::after {
  content: "           ";
  white-space: pre;
...
.better-moodle_src-style-marquee__marquee > span[data-rolling] {
  animation: better-moodle_src-style-marquee__marquee var(--rolling-duration) linear infinite;
}
.better-moodle_src-style-marquee__marquee > span[data-rolling] + span {
  display: inline-block;
}
.better-moodle_src-style-marquee__marquee > span[data-rolling] + span {
  animation: better-moodle_src-style-marquee__marquee var(--rolling-duration) linear infinite;
}
.better-moodle_src-style-marquee__marquee > span + span {
  display: none;
}
@media (prefers-reduced-motion: reduce) {
  ...
  .better-moodle_src-style-marquee__marquee > span[data-rolling]:hover {
    animation-name: better-moodle_src-style-marquee__marquee;
  }
}
@keyframes better-moodle_src-style-marquee__marquee {
  0% {
...
@media (min-width: 768px) {
  ...
  .better-moodle_src-style-marquee__marquee-min-width-placeholder:has(+ .better-moodle_src-style-marquee__marquee) {
    min-width: 200px;
  }
}
@media (max-width: 767.98px) {
  ...
  html[data-darkreader-scheme=dark] .better-moodle_src-style-marquee__marquee {
    background-color: rgba(0, 0, 0, 0.75);
  }
}.better-moodle_src-features-nina-__unseen::before {
  content: "";
  position: absolute;
  left: -8px;
  top: 0;
...
@media (prefers-reduced-motion: no-preference) {
  .better-moodle_src-features-nina-__spin {
    animation: better-moodle_src-features-nina-__spin 0.5s linear infinite;
  }
}
@keyframes better-moodle_src-features-nina-__spin {
  0% {
...
[data-block=better-moodle-semesterzeiten] .card-text.content .better-moodle_src-features-semesterzeiten-__today-span {
  position: absolute;
  top: 0;
...
[data-block=better-moodle-semesterzeiten] .card-text.content .better-moodle_src-features-semesterzeiten-__table-toggle {
  border: 0;
  max-width: 16px;
  margin-right: 0.5rem;
}
[data-block=better-moodle-semesterzeiten] .card-text.content .better-moodle_src-features-semesterzeiten-__progress-overlay-bar {
...
.better-moodle_src-features-speiseplan-__food-icon {
  display: var(--fa-display, inline-block);
  font-style: normal;
  font-variant: normal;
  line-height: 1;
...
html[data-darkreader-scheme=dark] .better-moodle_src-features-speiseplan-__dish-img {
  --stroke-color: color-mix(in srgb, currentColor 20%, transparent);
  filter: drop-shadow(0.5px 0 0 var(--stroke-color)) drop-shadow(-0.5px 0 0 var(--stroke-color)) drop-shadow(0 -0.5px 0 var(--stroke-color)) drop-shadow(0.5px 0.5px 0 var(--stroke-color)) drop-shadow(0.5px -0.5px 0 var(--stroke-color)) drop-shadow(-0.5px 0.5px 0 var(--stroke-color)) drop-shadow(-0.5px -0.5px 0 var(--stroke-color));
}
html[data-darkreader-scheme=dark] .better-moodle_src-features-speiseplan-__dish-img[src*=sh_teller] {
  filter: brightness(1.5);
}
html[data-darkreader-scheme=dark] .better-moodle_src-features-speiseplan-__dish-img[src*=iconprop_bio] {
  filter: brightness(0.9);
}
html[data-darkreader-scheme=dark] .better-moodle_src-features-speiseplan-__dish-img[src*=streetfood] {
  filter: brightness(1);
}
html[data-darkreader-scheme=dark] .better-moodle_src-features-speiseplan-__dish-img[src*=kuechen-klassiker] {
  filter: invert(1) saturate(1500%) hue-rotate(230deg) saturate(30%) hue-rotate(300deg);
  mix-blend-mode: screen;
}
html[data-darkreader-scheme=dark] .better-moodle_src-features-speiseplan-__dish-img[src*=your-favourites] {
  filter: invert(1) grayscale(2) brightness(2) sepia(1) sepia(1) sepia(1) sepia(1);
  mix-blend-mode: screen;
}

.better-moodle_src-features-speiseplan-__table .dish[data-location]::before {
...
.better-moodle_src-features-speiseplan-__table .dish[data-location=Mensa]::before {
  background-color: #6e894a;
  color: white;
}
.better-moodle_src-features-speiseplan-__table .dish[data-location=Canteen]::before {
  background-color: #6e894a;
  color: white;
}
.better-moodle_src-features-speiseplan-__table .dish[data-location=Cafeteria]::before {
  background-color: #4b6669;
  color: white;
}
.better-moodle_src-features-speiseplan-__table .dish .dish-additives {
  font-size: smaller;
}
.better-moodle_src-features-speiseplan-__table .co2-score[data-stars] {
  text-align: center;
}
.better-moodle_src-features-speiseplan-__table .co2-score[data-stars] > span {
  display: var(--fa-display, inline-block);
  font-style: normal;
  font-variant: normal;
  line-height: 1;
...
.better-moodle_src-features-speiseplan-__table .co2-score[data-stars][data-stars="1"] > span::before {
  content: "\\f005";
  font-weight: 900;
}
.better-moodle_src-features-speiseplan-__table .co2-score[data-stars][data-stars="1"] > span::after {
  content: "\\f005\\f005";
  font-weight: 400;
}
.better-moodle_src-features-speiseplan-__table .co2-score[data-stars][data-stars="2"] > span::before {
  content: "\\f005\\f005";
  font-weight: 900;
}
.better-moodle_src-features-speiseplan-__table .co2-score[data-stars][data-stars="2"] > span::after {
  content: "\\f005";
  font-weight: 400;
}
.better-moodle_src-features-speiseplan-__table .co2-score[data-stars][data-stars="3"] > span::before {
  content: "\\f005\\f005\\f005";
  font-weight: 900;
}
.better-moodle_src-features-speiseplan-__table .co2-score[data-stars][data-stars="3"] > span::after {
  content: "";
  font-weight: 400;
}
.better-moodle_src-features-speiseplan-__table .dish-types {
  text-align: center;
}
.better-moodle_src-features-speiseplan-__table .dish-types .better-moodle_src-features-speiseplan-__dish-img {
  max-width: 40px;
  max-height: 40px;
}

.modal-body:has(.better-moodle_src-features-speiseplan-__table) #speiseplan-filters-fieldset a.fheader:has(.fa-filter) {
  zoom: 0.75;
}
.modal-body:has(.better-moodle_src-features-speiseplan-__table) #speiseplan-filters-fieldset h3 {
  font-size: medium;
}
.modal-body:has(.better-moodle_src-features-speiseplan-__table) #speiseplan-filters-fieldset .better-moodle_src-features-speiseplan-__dish-img {
  max-height: 2ch;
  margin-right: 0.3em;
}
.modal-body:has(.better-moodle_src-features-speiseplan-__table) #speiseplan-filters-fieldset .fcontainer:is(.collapsing, .show) {
  padding-bottom: 0.5rem;
  display: flex;
  flex-wrap: wrap;
}
.modal-body:has(.better-moodle_src-features-speiseplan-__table) #speiseplan-filters-fieldset .fcontainer:is(.collapsing, .show) .form-autocomplete-selection {
  order: 1;
}.better-moodle_src-features-courses-images-zoom__zoom-enabled #region-main img:not(.activityicon):not(.icon) {
  cursor: zoom-in;
}

#better-moodle_src-features-courses-images-zoom__overlay {
  position: fixed;
  top: 0;
  bottom: 0;
  left: 0;
...
#better-moodle_src-features-courses-images-zoom__overlay > img {
  cursor: zoom-out;
  transform: scale(0);
  transition: transform 0.2s ease-in-out;
  will-change: transform;
}.better-moodle_src-features-courses-navbarDropdown-__desktop + .dropdown-menu {
  max-width: 500px;
}
.better-moodle_src-features-courses-navbarDropdown-__desktop + .dropdown-menu a {
  overflow: hidden;
  text-overflow: ellipsis;
}#better-moodle_src-features-dashboard-layout__courses_sidebar-filter-menu .list-group-item {
  padding: 0.25rem 1.5rem;
}
#better-moodle_src-features-dashboard-layout__courses_sidebar-filter-menu .list-group-item:hover {
  background-color: var(--primary);
  color: white;
}
#better-moodle_src-features-dashboard-layout__courses_sidebar-filter-menu .list-group-item.active::before {
  display: var(--fa-display, inline-block);
  font-style: normal;
  font-variant: normal;
  line-height: 1;
  ...
  content: "\\f00c";
  margin-right: 0.5em;
}#better-moodle_src-features-general-googlyEyes__eyes {
  display: flex;
  width: 100%;
  height: 100%;
  justify-content: center;
...
#better-moodle_src-features-general-googlyEyes__eyes .better-moodle_src-features-general-googlyEyes__eye {
  position: relative;
...
#better-moodle_src-features-general-googlyEyes__eyes .better-moodle_src-features-general-googlyEyes__eye:not(:last-child) {
  margin-right: 5%;
}
#better-moodle_src-features-general-googlyEyes__eyes .better-moodle_src-features-general-googlyEyes__eye .better-moodle_src-features-general-googlyEyes__pupil {
...
#better-moodle_src-features-general-googlyEyes__eyes .better-moodle_src-features-general-googlyEyes__eye::before {
  content: "";
  position: absolute;
  top: 0;
  right: 0;
...
body:has(input[type=password]:focus) #better-moodle_src-features-general-googlyEyes__eyes .better-moodle_src-features-general-googlyEyes__eye::before {
  opacity: 1;
}body:not(.limitedwidth).better-moodle_src-features-general-leftSecondaryNav__pulled .secondary-navigation .navigation .nav-tabs {
  justify-content: flex-start;
}img.better-moodle_src-features-general-prideLogo__pride-logo {
  filter: brightness(0.8) contrast(1.5);
  object-position: -99999px -99999px;
  mask: var(--pride-logo-mask-image) no-repeat content-box center/contain alpha;
}
img.better-moodle_src-features-general-prideLogo__pride-logo.better-moodle_src-features-general-prideLogo__rotation-180deg.better-moodle_src-features-general-prideLogo__flag-rainbow {
  background-image: linear-gradient(180deg, #fe0000 0% 25%, #fd8c00 24% 37%, #ffd000 37% 50%, #119f0b 49% 62%, #457cdf 62% 75%, #c22edc 74% 100%);
}
img.better-moodle_src-features-general-prideLogo__pride-logo.better-moodle_src-features-general-prideLogo__rotation-180deg.better-moodle_src-features-general-prideLogo__flag-agender {
...
img.better-moodle_src-features-general-prideLogo__pride-logo.better-moodle_src-features-general-prideLogo__rotation-180deg.better-moodle_src-features-general-prideLogo__flag-aro {
  background-image: linear-gradient(180deg, #008800 0% 27%, #6dc049 27% 42%, #f3f3f3 42% 57%, #868686 57% 72%, #000000 72% 100%);
}
img.better-moodle_src-features-general-prideLogo__pride-logo.better-moodle_src-features-general-prideLogo__rotation-180deg.better-moodle_src-features-general-prideLogo__flag-ace {
  background-image: linear-gradient(180deg, #000000 0% 31%, #75005f 30% 49%, #f3f3f3 49% 68%, #868686 68% 100%);
}
img.better-moodle_src-features-general-prideLogo__pride-logo.better-moodle_src-features-general-prideLogo__rotation-180deg.better-moodle_src-features-general-prideLogo__flag-aroace {
  background-image: linear-gradient(180deg, #ce6600 0% 27%, #dbb600 27% 42%, #f3f3f3 42% 57%, #3592ca 57% 72%, #000529 72% 100%);
}
img.better-moodle_src-features-general-prideLogo__pride-logo.better-moodle_src-features-general-prideLogo__rotation-180deg.better-moodle_src-features-general-prideLogo__flag-bi {
  background-image: linear-gradient(180deg, #d60270 0% 37%, #9b4f96 37% 62%, #0038a8 62% 100%);
}
img.better-moodle_src-features-general-prideLogo__pride-logo.better-moodle_src-features-general-prideLogo__rotation-180deg.better-moodle_src-features-general-prideLogo__flag-genderfluid {
  background-image: linear-gradient(180deg, #f04e83 0% 27%, #f3f3f3 27% 42%, #ca00c7 42% 57%, #000000 57% 72%, #0007a8 72% 100%);
}
img.better-moodle_src-features-general-prideLogo__pride-logo.better-moodle_src-features-general-prideLogo__rotation-180deg.better-moodle_src-features-general-prideLogo__flag-lesbian {
  background-image: linear-gradient(180deg, #c00000 0% 27%, #f07724 27% 42%, #f3f3f3 42% 57%, #bb3586 57% 72%, #860035 72% 100%);
}
img.better-moodle_src-features-general-prideLogo__pride-logo.better-moodle_src-features-general-prideLogo__rotation-180deg.better-moodle_src-features-general-prideLogo__flag-enby {
  background-image: linear-gradient(180deg, #ece22c 0% 31%, #f3f3f3 30% 49%, #7035b6 49% 68%, #000000 68% 100%);
}
img.better-moodle_src-features-general-prideLogo__pride-logo.better-moodle_src-features-general-prideLogo__rotation-180deg.better-moodle_src-features-general-prideLogo__flag-pan {
  background-image: linear-gradient(180deg, #f3006d 0% 37%, #f0c500 37% 62%, #0097f0 62% 100%);
}
img.better-moodle_src-features-general-prideLogo__pride-logo.better-moodle_src-features-general-prideLogo__rotation-180deg.better-moodle_src-features-general-prideLogo__flag-gay {
  background-image: linear-gradient(180deg, #006642 0% 27%, #6dc79b 27% 42%, #f3f3f3 42% 57%, #5086c2 57% 72%, #0f004b 72% 100%);
}
img.better-moodle_src-features-general-prideLogo__pride-logo.better-moodle_src-features-general-prideLogo__rotation-180deg.better-moodle_src-features-general-prideLogo__flag-trans {
  background-image: linear-gradient(180deg, #00b9ee 0% 27%, #ee86d8 27% 42%, #f3f3f3 42% 57%, #ee86d8 57% 72%, #00b9ee 72% 100%);
}
img.better-moodle_src-features-general-prideLogo__pride-logo.better-moodle_src-features-general-prideLogo__rotation-180deg.better-moodle_src-features-general-prideLogo__flag-intersex {
  background-image: radial-gradient(circle at 50%, #f3c500 12%, #680088 12% 22%, #f3c500 22%);
}
img.better-moodle_src-features-general-prideLogo__pride-logo.better-moodle_src-features-general-prideLogo__rotation-135deg.better-moodle_src-features-general-prideLogo__flag-rainbow {
  background-image: linear-gradient(135deg, #fe0000 0% 32%, #fd8c00 31% 41%, #ffd000 40% 50%, #119f0b 50% 60%, #457cdf 59% 69%, #c22edc 68% 100%);
}
img.better-moodle_src-features-general-prideLogo__pride-logo.better-moodle_src-features-general-prideLogo__rotation-135deg.better-moodle_src-features-general-prideLogo__flag-agender {
...
img.better-moodle_src-features-general-prideLogo__pride-logo.better-moodle_src-features-general-prideLogo__rotation-135deg.better-moodle_src-features-general-prideLogo__flag-aro {
  background-image: linear-gradient(135deg, #008800 0% 34%, #6dc049 33% 45%, #f3f3f3 44% 56%, #868686 55% 67%, #000000 66% 100%);
}
img.better-moodle_src-features-general-prideLogo__pride-logo.better-moodle_src-features-general-prideLogo__rotation-135deg.better-moodle_src-features-general-prideLogo__flag-ace {
  background-image: linear-gradient(135deg, #000000 0% 36%, #75005f 36% 50%, #f3f3f3 50% 64%, #868686 64% 100%);
}
img.better-moodle_src-features-general-prideLogo__pride-logo.better-moodle_src-features-general-prideLogo__rotation-135deg.better-moodle_src-features-general-prideLogo__flag-aroace {
  background-image: linear-gradient(135deg, #ce6600 0% 34%, #dbb600 33% 45%, #f3f3f3 44% 56%, #3592ca 55% 67%, #000529 66% 100%);
}
img.better-moodle_src-features-general-prideLogo__pride-logo.better-moodle_src-features-general-prideLogo__rotation-135deg.better-moodle_src-features-general-prideLogo__flag-bi {
  background-image: linear-gradient(135deg, #d60270 0% 41%, #9b4f96 40% 59%, #0038a8 59% 100%);
}
img.better-moodle_src-features-general-prideLogo__pride-logo.better-moodle_src-features-general-prideLogo__rotation-135deg.better-moodle_src-features-general-prideLogo__flag-genderfluid {
  background-image: linear-gradient(135deg, #f04e83 0% 34%, #f3f3f3 33% 45%, #ca00c7 44% 56%, #000000 55% 67%, #0007a8 66% 100%);
}
img.better-moodle_src-features-general-prideLogo__pride-logo.better-moodle_src-features-general-prideLogo__rotation-135deg.better-moodle_src-features-general-prideLogo__flag-lesbian {
  background-image: linear-gradient(135deg, #c00000 0% 34%, #f07724 33% 45%, #f3f3f3 44% 56%, #bb3586 55% 67%, #860035 66% 100%);
}
img.better-moodle_src-features-general-prideLogo__pride-logo.better-moodle_src-features-general-prideLogo__rotation-135deg.better-moodle_src-features-general-prideLogo__flag-enby {
  background-image: linear-gradient(135deg, #ece22c 0% 36%, #f3f3f3 36% 50%, #7035b6 50% 64%, #000000 64% 100%);
}
img.better-moodle_src-features-general-prideLogo__pride-logo.better-moodle_src-features-general-prideLogo__rotation-135deg.better-moodle_src-features-general-prideLogo__flag-pan {
  background-image: linear-gradient(135deg, #f3006d 0% 41%, #f0c500 40% 59%, #0097f0 59% 100%);
}
img.better-moodle_src-features-general-prideLogo__pride-logo.better-moodle_src-features-general-prideLogo__rotation-135deg.better-moodle_src-features-general-prideLogo__flag-gay {
  background-image: linear-gradient(135deg, #006642 0% 34%, #6dc79b 33% 45%, #f3f3f3 44% 56%, #5086c2 55% 67%, #0f004b 66% 100%);
}
img.better-moodle_src-features-general-prideLogo__pride-logo.better-moodle_src-features-general-prideLogo__rotation-135deg.better-moodle_src-features-general-prideLogo__flag-trans {
  background-image: linear-gradient(135deg, #00b9ee 0% 34%, #ee86d8 33% 45%, #f3f3f3 44% 56%, #ee86d8 55% 67%, #00b9ee 66% 100%);
}
img.better-moodle_src-features-general-prideLogo__pride-logo.better-moodle_src-features-general-prideLogo__rotation-135deg.better-moodle_src-features-general-prideLogo__flag-intersex {
  background-image: radial-gradient(circle at 50%, #f3c500 12%, #680088 12% 22%, #f3c500 22%);
}
html[data-darkreader-scheme=dark] img.better-moodle_src-features-general-prideLogo__pride-logo {
  filter: saturate(2) !important;
}.better-moodle_src-features-navbarMarquee-eventAdvertisements__event-advertisement {
  cursor: pointer;
} `);
  ...
  const globalStyle = {
    noExternalLinkIcon: 'better-moodle_src-style-__no-external-link-icon',
    awaitsDropdown: 'better-moodle_src-style-__awaits-dropdown',
    navbarItem: 'better-moodle_src-style-__navbar-item',
    shining: 'better-moodle_src-style-__shining',
    sparkling: 'better-moodle_src-style-__sparkling',
  };
  const require$1 = (modules, callback) => readyCallback(() => requirejs(modules, callback));
  const requirePromise = modules => new Promise(resolve => require$1(modules, (...res) => resolve(res)));
  ...
  const renderCustomTemplateAsElements = (name, template, context) =>
    renderCustomTemplate(name, template, context).then(({ html }) => htmlToElements(html));
  ...
  const renderAsElements = (templateName, context, themeName) =>
    render(templateName, context, themeName).then(({ html }) => htmlToElements(html));
  const renderAsElement = (templateName, context, themeName) =>
    renderAsElements(templateName, context, themeName).then(elements => elements.item(0));
  ...
  const isLoggedIn = () => moodleAndDomReady().then(() => (M.cfg.userId ?? 0) > 1);
  ...
  const moodleReady = (checkDelay = 1) => {
    ...
    const check = () => {
      if ('undefined' !== typeof M) return resolve();
  ...
  const featurePrerequisitesReady = async (loadPrerequisites, defaultPrerequisites = 'moodle-and-dom-ready') => {
  ...
  const mdlJSComplete = async action => {
    await moodleReady();
    const { promise, resolve } = Promise.withResolvers();
    const check = () => {
  ...
  const dateFormat = ({ weekday, year }) => ({
    weekday: weekday ? 'long' : void 0,
    year: year ? 'numeric' : void 0,
    month: '2-digit',
    day: '2-digit',
  });
  const timeFormat = seconds2 => ({ hour: '2-digit', minute: '2-digit', second: seconds2 ? '2-digit' : void 0 });
  ...
  const timeToString = (date, seconds2 = true, lang = BETTER_MOODLE_LANG) =>
    date.toLocaleTimeString(lang, timeFormat(seconds2));
  const datetimeToString = (date, year = true, weekday = true, seconds2 = false, lang = BETTER_MOODLE_LANG) =>
    date.toLocaleString(lang, { ...dateFormat({ year, weekday }), ...timeFormat(seconds2) });
  ...
  const courseIndexDrawerControls = {
    de: {
      settings: {
        enabled: {
    ...
    en: {
      settings: {
        enabled: {
          ...
          description: 'Adds controls to collapse/expand all sections in the sidebar at once.',
        },
      },
    },
  };
  ...
  const cauNavbar = {
    de: {
      settings: {
        mode: {
          name: 'CAU Knöpfe',
          description: 'Wähle einen schöneren Weg, um die SOS Knöpfe der CAU darzustellen.',
    ...
    en: {
      settings: {
        mode: {
          name: 'CAU Buttons',
          description: 'Choose a nicer way to display the SOS buttons of the CAU.',
          options: { default: 'Default' },
        },
      },
      buttons: {
        sos: { sos: 'SOS' },
        discrimination: { discriminationSexism: 'Discrimination / Sexism', report: 'report', getHelp: 'get help' },
      },
    },
  };
  const externalLinks = {
      ...
      features: {
        ...
        linkIcons: {
          ...
          settings: {
            ...
            mattermostIfI: {
              name: 'Mattermost',
              description: 'Zeigt ein kleines Icon an, wenn ein Link zur Mattermostinstanz des IfI führt.',
            },
            phone: {
              name: 'Telefonnummern',
              description: 'Zeigt ein kleines Icon an, wenn ein Link zu einer Telefonnummer führt.',
            },
            webex: { name: 'Webex', description: 'Zeigt ein kleines Icon an, wenn ein Link zu Webex führt.' },
          },
        },
        messages: de$9,
        navbarMarquee: de$5,
      ...
      features: {
        ...
        linkIcons: {
          ...
          settings: {
            ...
            mattermostIfI: {
              name: 'Mattermost',
              description: 'Shows a small icon next to links that lead to the institutes mattermost instance.',
            },
            phone: { name: 'Phone', description: 'Shows a small icon next to links that are phone numbers.' },
            webex: { name: 'Webex', description: 'Shows a small icon next to links that lead to webex.' },
          },
        },
        messages: en$8,
        navbarMarquee: en$4,
  ...
  const settingsStyle = {
    openSettingsBtn: 'better-moodle_src-style-settings__open-settings-btn',
    newSettingBadge: 'better-moodle_src-style-settings__new-setting-badge',
    settingsForm: 'better-moodle_src-style-settings__settings-form',
    supportWrapper: 'better-moodle_src-style-settings__support-wrapper',
    hideDisabledSettings: 'better-moodle_src-style-settings__hide-disabled-settings',
    hideNewSettingBadges: 'better-moodle_src-style-settings__hide-new-setting-badges',
    hideFunSettings: 'better-moodle_src-style-settings__hide-fun-settings',
    settingsFooterBtns: 'better-moodle_src-style-settings__settings-footer-btns',
  };
  const TempStorage$1 = new (class TempStorage {
    settingsRequireReload = false;
  })();
  const toast = (message, config) => requirePromise(['core/toast']).then(([{ add: add2 }]) => add2(message, config));
  const tags = { fun: '🎡' };
  ...
  class Setting extends CanBeReady {
    ...
    #addUpdateOnSync() {
      ...
      this.#syncListener = GM_addValueChangeListener(this.settingKey, (_, __, ___, remote) => {
        ...
        if (this.#requiresReload) {
          toast(mdToHtml(LL$a.settings.syncRequireReload({ name: this.title })), {
            type: 'info',
            autohide: false,
            closeButton: true,
          });
        } else toast(LL$a.settings.sync({ name: this.title }), { type: 'success', autohide: true });
      });
    }
    ...
    requireReload() {
      ...
      this.onChange(() => {
        ...
        toast(mdToHtml(LL$a.settings.requireReload({ name: this.title })), {
          type: 'info',
          autohide: false,
          closeButton: true,
        });
  ...
  const sliderStyle = { sliderSetting: 'better-moodle_src-style-settings-SliderSetting__slider-setting' };
  ...
  const AutoComplete = ({ id, value, options, multiple = true, tags: tags2 = false, placeholder = '' }) => {
    const Select2 = createElement('select', { id, multiple });
    const waitForOptions = new SimpleReady();
    Promise.resolve(options).then(options2 => {
      Select2.append(
        ...options2.map(option =>
          createElement(
            'option',
            { 'value': option.value, 'selected': value.includes(option.value), 'data-html': option.html },
            option.text
          )
        )
      );
    ...
    new MutationObserver((records, observer) =>
      records.forEach(record => {
        if (initing) return;
        if ('childList' !== record.type) return;
        if (!record.addedNodes.values().find(el => el === Select2)) return;
        observer.disconnect();
        initing = true;
        waitForOptions
          .awaitReady()
          .then(() => requirePromise(['core/form-autocomplete']))
          .then(([{ enhanceField }]) => enhanceField(`#${id}`, tags2, void 0, placeholder))
          .then(() => (initing = false));
      })
    ).observe(document, { subtree: true, childList: true });
    Object.defineProperty(Select2, 'value', {
      get() {
        return Array.from(Select2.selectedOptions).map(option => option.value);
      },
      set(newValue) {
        const selectionElement = Select2.parentElement?.querySelector('.form-autocomplete-selection');
        const suggestionsElement = Select2.parentElement?.querySelector('.form-autocomplete-suggestions');
        if (!selectionElement || !suggestionsElement) {
          throw new Error("Couldn't find required elements in autocomplete!");
        }
        selectionElement
          .querySelectorAll(`[role="option"]${newValue.map(v => `:not([data-value="${v}"])`).join('')}`)
          .forEach(el => el.click());
        suggestionsElement
          .querySelectorAll(`[role="option"]:is(${newValue.map(v => `[data-value="${v}"]`).join(',')})`)
          .forEach(el => el.click());
      },
    });
    return Select2;
  ...
  const FieldSet = ({
    ...
    renderAsElements('core_form/element-header', { header: title, id: PREFIX(id), collapseable: true, collapsed })
      .then(elements => FieldSet2.append(...Array.from(elements)))
      .then(() => {
        container = FieldSet2.querySelector('.fcontainer');
        container?.append(
          createElement(Fragment, null, description ? htmlToElements(mdToHtml(description)) : null, children)
        );
  ...
  class FeatureGroup {
    static register({
      settings: settings2 = new Set(),
      features: features2 = new Set(),
      ...
      return class FeatureGroup extends this {
        constructor(id) {
          super(id, settings2 ?? new Set(), methods, loadPrerequisites);
        }
        loadFeatures(loadFn) {
          ...
          if (featuresInheritPrerequisites) inheritedPrerequisites = this.#loadPrerequisites;
    ...
    #loaded = false;
    constructor(id, settings2, methods, loadTiming) {
      this.#id = id;
  ...
  const modalStyle = {
    modalBackgroundImage: 'better-moodle_src-style-modal__modal-background-image',
    modalTrigger: 'better-moodle_src-style-modal__modal-trigger',
  };
  const TypeTo403Lib = {
  ...
  class Modal extends CanBeReady {
    ...
    async #onReady() {
      if (this.#savedFooter) this.#modal.getFooter().prepend(await this.#savedFooter);
      if (this.#config.bodyClass) {
        const bodyClassPromise = this.#modal
          .getBodyPromise()
          .then(([body]) => body.classList.add(...className(this.#config.bodyClass).split(' ')));
    ...
    async #create() {
      const { promise, resolve } = Promise.withResolvers();
      require$1([TypeTo403Lib[this.#config.type], 'core/modal_events'], (modalClass, modalEvents) => {
  ...
  const style$7 = {
    dropdown: 'better-moodle_src-features-bookmarks-__dropdown',
    form: 'better-moodle_src-features-bookmarks-__form',
    editForm: 'better-moodle_src-features-bookmarks-__edit-form',
  };
  const LL$9 = LLFG('bookmarks');
  const enabled$h = new BooleanSetting('enabled', false).addAlias('general.bookmarkManager');
  ...
  const saveBookmarks = () => {
    ...
    toast(LL$9.savedNotification(), { type: 'success', autohide: true, closeButton: true });
  };
  GM_addValueChangeListener('bookmarks.list', (_, __, newBookmarks) => {
    if (!enabled$h.value) return;
  ...
  const openEditModal = () => {
    ...
    const addBtn = createElement(
      'button',
      { className: 'btn btn-outline-success pull-right float-end' },
    ...
    new Modal({
      ...
      .onSave(() => {
        bookmarks.splice(
          ...
          bookmarks.length,
          ...Array.from(inputs.values())
            .toSorted((a2, b) => a2.index - b.index)
  ...
  enabled$h.onInput(() => void reload$g());
  const bookmarks$1 = FeatureGroup.register({ settings: new Set([enabled$h]), onload: reload$g, onunload: reload$g });
  ...
  const courses = FeatureGroup.register({ features: features$3 });
  importCSS(
  ...
  const darkmode = FeatureGroup.register({
    settings: settings$3,
    onload: () =>
  ...
  const dashboard = FeatureGroup.register({ features: features$2 });
  ...
  const general = FeatureGroup.register({
    settings: new Set([
      updateNotification,
      languageSetting,
  ...
  var a;
  const d = b => ((a = document.createElement('style')).append(b), a);
  const mailStyleEl = d(
    'body.dir-ltr a[href^="mailto:"]:not(:has(.fa-envelope)):not(:has(*)):not(:empty)::before, body.dir-rtl a[href^="mailto:"]:not(:has(.fa-envelope)):not(:has(*)):not(:empty)::after, body.dir-ltr a[href^="mailto:"]:not(:has(.fa-envelope)):has(*:not(:empty))::before, body.dir-rtl a[href^="mailto:"]:not(:has(.fa-envelope)):has(*:not(:empty))::after {\n  padding-inline-end: 0.25rem;\n  display: var(--fa-display, inline-block);\n  font-style: normal;\n  font-variant: normal;\n  line-height: 1;\n  text-rendering: auto;\n  font-family: var(--fa-style-family, "Font Awesome 6 Free");\n  font-weight: var(--fa-style, 900);\n  content: "\\f003" !important;\n  display: inline;\n}'
  );
  const phoneStyleEl = d(
    'body.dir-ltr a[href^="tel:"]:not(:has(.fa-phone)):not(:has(*)):not(:empty)::before, body.dir-rtl a[href^="tel:"]:not(:has(.fa-phone)):not(:has(*)):not(:empty)::after, body.dir-ltr a[href^="tel:"]:not(:has(.fa-phone)):has(*:not(:empty))::before, body.dir-rtl a[href^="tel:"]:not(:has(.fa-phone)):has(*:not(:empty))::after {\n  padding-inline-end: 0.25rem;\n  display: var(--fa-display, inline-block);\n  font-style: normal;\n  font-variant: normal;\n  line-height: 1;\n  text-rendering: auto;\n  font-family: var(--fa-style-family, "Font Awesome 6 Free");\n  font-weight: var(--fa-style, 900);\n  content: "\\f095" !important;\n  display: inline;\n}'
  );
  const settings$2 = new Set();
  let webex;
  webex = new BooleanSetting('webex', true).onInput(() => onload$8());
  settings$2.add(webex);
  ...
  const onload$8 = () => {
    ...
    if (webex?.value) {
      if (webexStyle) document.head.append(webexStyle);
        ...
        webexStyle =
          GM_addStyle(`body.dir-ltr a[href^="webexteams://"]:not(:has(*)):not(:empty)::before, body.dir-rtl a[href^="webexteams://"]:not(:has(*)):not(:empty)::after, body.dir-ltr a[href^="webexteams://"]:has(*:not(:empty))::before, body.dir-rtl a[href^="webexteams://"]:has(*:not(:empty))::after,
body.dir-ltr a[href^="https://uni-luebeck.webex.com"]:not(:has(*)):not(:empty)::before,
body.dir-rtl a[href^="https://uni-luebeck.webex.com"]:not(:has(*)):not(:empty)::after,
body.dir-ltr a[href^="https://uni-luebeck.webex.com"]:has(*:not(:empty))::before,
body.dir-rtl a[href^="https://uni-luebeck.webex.com"]:has(*:not(:empty))::after {
  padding-inline-end: 0.25rem;
  display: var(--fa-display, inline-block);
  font-style: normal;
  font-variant: normal;
  ...
  display: inline;
  color: transparent;
  background-image: url("data:image/svg+xml,%3c!-- downloaded from https://idbroker-eu.webex.com/idb/images/webex-3d-logo.svg copyright of this logo belongs to cisco --%3e %3c!-- simplified the svg afterwards by using https://svgomg.net/ --%3e %3csvg xmlns='http://www.w3.org/2000/svg' fill='none' viewBox='0 0 88 64'%3e%3cdefs%3e%3cradialGradient id='b' cx='0' cy='0' r='1' gradientTransform='matrix(-19 -32 27 -16 33 34)' gradientUnits='userSpaceOnUse'%3e%3cstop stop-color='%23007383'/%3e%3cstop offset='.4' stop-color='%2300717E' stop-opacity='.8'/%3e%3cstop offset='.9' stop-color='%23007281' stop-opacity='0'/%3e%3c/radialGradient%3e%3cradialGradient id='c' cx='0' cy='0' r='1' gradientTransform='matrix(-18 -25 16 -12 58 27)' gradientUnits='userSpaceOnUse'%3e%3cstop stop-color='%23218970'/%3e%3cstop offset='.5' stop-color='%23267E6A'/%3e%3cstop offset='1' stop-color='%23026C51' stop-opacity='0'/%3e%3c/radialGradient%3e%3cradialGradient id='d' cx='0' cy='0' r='1' gradientTransform='matrix(-8 -24 12 -4 31 36)' gradientUnits='userSpaceOnUse'%3e%3cstop stop-color='%23178697'/%3e%3cstop offset='.4' stop-color='%2317838F' stop-opacity='.8'/%3e%3cstop offset='.9' stop-color='%23007281' stop-opacity='0'/%3e%3c/radialGradient%3e%3cradialGradient id='e' cx='0' cy='0' r='1' gradientTransform='matrix(-33 -55 17 -10 42 36)' gradientUnits='userSpaceOnUse'%3e%3cstop stop-color='%2325342F' stop-opacity='.3'/%3e%3cstop offset='1' stop-color='%2325342F' stop-opacity='0'/%3e%3c/radialGradient%3e%3cradialGradient id='f' cx='0' cy='0' r='1' gradientTransform='matrix(2 24 -14 1 54 28)' gradientUnits='userSpaceOnUse'%3e%3cstop stop-color='%23056D4F'/%3e%3cstop offset='.2' stop-color='%23056C4E' stop-opacity='.8'/%3e%3cstop offset='.6' stop-color='%23056C4E' stop-opacity='.3'/%3e%3cstop offset='.9' stop-color='%23056C4F' stop-opacity='0'/%3e%3c/radialGradient%3e%3cradialGradient id='g' cx='0' cy='0' r='1' gradientTransform='matrix(15 24 -12 8 55 -11)' gradientUnits='userSpaceOnUse'%3e%3cstop stop-color='%2322B67B'/%3e%3cstop offset='.4' stop-color='%2324BE82'/%3e%3cstop offset='1' stop-color='%2324BE82' stop-opacity='.1'/%3e%3c/radialGradient%3e%3cradialGradient id='i' cx='0' cy='0' r='1' gradientTransform='matrix(24 28 -28 24 -13 -5)' gradientUnits='userSpaceOnUse'%3e%3cstop stop-color='%2309F8FF'/%3e%3cstop offset='1' stop-color='%230BF7F9' stop-opacity='0'/%3e%3c/radialGradient%3e%3cradialGradient id='j' cx='0' cy='0' r='1' gradientTransform='matrix(50 55 -55 50 17 -24)' gradientUnits='userSpaceOnUse'%3e%3cstop stop-color='%2300B8FF'/%3e%3cstop offset='.7' stop-color='%2300B9FC' stop-opacity='0'/%3e%3c/radialGradient%3e%3cradialGradient id='k' cx='0' cy='0' r='1' gradientTransform='matrix(-11 -34 24 -7 21 32)' gradientUnits='userSpaceOnUse'%3e%3cstop stop-color='%2300BCFF' stop-opacity='.8'/%3e%3cstop offset='.6' stop-color='%2300BAFC' stop-opacity='0'/%3e%3c/radialGradient%3e%3cradialGradient id='l' cx='0' cy='0' r='1' gradientTransform='matrix(-16 -20 14 -11 75 18)' gradientUnits='userSpaceOnUse'%3e%3cstop stop-color='%235FEC50'/%3e%3cstop offset='1' stop-color='%233CC08E' stop-opacity='0'/%3e%3c/radialGradient%3e%3cradialGradient id='m' cx='0' cy='0' r='1' gradientTransform='matrix(1 -8 5 1 72 35)' gradientUnits='userSpaceOnUse'%3e%3cstop stop-color='%2328855B'/%3e%3cstop offset='1' stop-color='%2314795C' stop-opacity='0'/%3e%3c/radialGradient%3e%3cradialGradient id='n' cx='0' cy='0' r='1' gradientTransform='matrix(1 -6 9 2 71 34)' gradientUnits='userSpaceOnUse'%3e%3cstop stop-color='%2328855B'/%3e%3cstop offset='1' stop-color='%2314795C' stop-opacity='0'/%3e%3c/radialGradient%3e%3cradialGradient id='o' cx='0' cy='0' r='1' gradientTransform='matrix(-14 -15 11 -10 79 23)' gradientUnits='userSpaceOnUse'%3e%3cstop stop-color='%235FF05B'/%3e%3cstop offset='.8' stop-color='%235DE955' stop-opacity='0'/%3e%3c/radialGradient%3e%3cradialGradient id='p' cx='0' cy='0' r='1' gradientTransform='matrix(15 11 -16 21 72 29)' gradientUnits='userSpaceOnUse'%3e%3cstop stop-color='%23123AA8'/%3e%3cstop offset='1' stop-color='%23123AA8' stop-opacity='0'/%3e%3c/radialGradient%3e%3cradialGradient id='q' cx='0' cy='0' r='1' gradientTransform='matrix(22 3 -5 33 67 31)' gradientUnits='userSpaceOnUse'%3e%3cstop stop-color='%23123AA8'/%3e%3cstop offset='.6' stop-color='%23123AA8' stop-opacity='0'/%3e%3c/radialGradient%3e%3cradialGradient id='r' cx='0' cy='0' r='1' gradientTransform='matrix(17 8 -14 31 69 34)' gradientUnits='userSpaceOnUse'%3e%3cstop stop-color='%23123AA8'/%3e%3cstop offset='.8' stop-color='%23123AA8' stop-opacity='0'/%3e%3c/radialGradient%3e%3cradialGradient id='s' cx='0' cy='0' r='1' gradientTransform='matrix(-3 34 -18 -2 67 35)' gradientUnits='userSpaceOnUse'%3e%3cstop stop-color='%23123AA8'/%3e%3cstop offset='.6' stop-color='%23123AA8' stop-opacity='0'/%3e%3cstop offset='1' stop-color='%23123AA8' stop-opacity='0'/%3e%3c/radialGradient%3e%3cradialGradient id='t' cx='0' cy='0' r='1' gradientTransform='matrix(-3 41 -15 -1 72 20)' gradientUnits='userSpaceOnUse'%3e%3cstop stop-color='%23123AA8'/%3e%3cstop offset='.9' stop-color='%23123AA8' stop-opacity='0'/%3e%3c/radialGradient%3e%3cradialGradient id='u' cx='0' cy='0' r='1' gradientTransform='matrix(2 22 -11 1 26 28)' gradientUnits='userSpaceOnUse'%3e%3cstop stop-color='%23123AA8'/%3e%3cstop offset='.9' stop-color='%23123AA8' stop-opacity='0'/%3e%3c/radialGradient%3e%3cradialGradient id='v' cx='0' cy='0' r='1' gradientTransform='matrix(1 23 -19 1 26 29)' gradientUnits='userSpaceOnUse'%3e%3cstop stop-color='%23123AA8'/%3e%3cstop offset='.9' stop-color='%23123AA8' stop-opacity='0'/%3e%3c/radialGradient%3e%3cradialGradient id='w' cx='0' cy='0' r='1' gradientTransform='matrix(23 -10 19 45 31 50)' gradientUnits='userSpaceOnUse'%3e%3cstop stop-color='%23123AA8'/%3e%3cstop offset='.7' stop-color='%23123AA8' stop-opacity='0'/%3e%3c/radialGradient%3e%3cradialGradient id='x' cx='0' cy='0' r='1' gradientTransform='matrix(-16 -6 10 -27 22 23)' gradientUnits='userSpaceOnUse'%3e%3cstop stop-color='%231A3DA0'/%3e%3cstop offset='.7' stop-color='%23123AA8' stop-opacity='0'/%3e%3c/radialGradient%3e%3cradialGradient id='y' cx='0' cy='0' r='1' gradientTransform='matrix(31 9 -9 31 7 29)' gradientUnits='userSpaceOnUse'%3e%3cstop stop-color='%231E3882'/%3e%3cstop offset='.8' stop-color='%23123AA8' stop-opacity='0'/%3e%3c/radialGradient%3e%3cradialGradient id='A' cx='0' cy='0' r='1' gradientTransform='matrix(24 28 -28 24 -13 -5)' gradientUnits='userSpaceOnUse'%3e%3cstop stop-color='%2309F8FF'/%3e%3cstop offset='1' stop-color='%230BF7F9' stop-opacity='0'/%3e%3c/radialGradient%3e%3cradialGradient id='D' cx='0' cy='0' r='1' gradientTransform='matrix(-11 -34 24 -7 21 32)' gradientUnits='userSpaceOnUse'%3e%3cstop stop-color='%2300BCFF' stop-opacity='.8'/%3e%3cstop offset='.6' stop-color='%2300BAFC' stop-opacity='0'/%3e%3c/radialGradient%3e%3clinearGradient id='a' x1='73' x2='15.5' y1='18.7' y2='37.6' gradientUnits='userSpaceOnUse'%3e%3cstop stop-color='%235CEE64'/%3e%3cstop offset='1' stop-color='%230BF'/%3e%3c/linearGradient%3e%3clinearGradient id='h' x1='-21.7' x2='19.1' y1='31.3' y2='31.7' gradientUnits='userSpaceOnUse'%3e%3cstop stop-color='%2309F8FF'/%3e%3cstop offset='1' stop-color='%230BF7F9' stop-opacity='0'/%3e%3c/linearGradient%3e%3clinearGradient id='z' x1='-2.6' x2='28.7' y1='11.4' y2='31.4' gradientUnits='userSpaceOnUse'%3e%3cstop offset='.2' stop-color='%231DC4FF'/%3e%3cstop offset='1' stop-color='%231CC1FF' stop-opacity='0'/%3e%3c/linearGradient%3e%3clinearGradient id='B' x1='-.9' x2='7.9' y1='12.4' y2='20.4' gradientUnits='userSpaceOnUse'%3e%3cstop stop-color='%2326FBFF'/%3e%3cstop offset='.6' stop-color='%230BF7F9' stop-opacity='0'/%3e%3c/linearGradient%3e%3clinearGradient id='C' x1='-3.3' x2='8.9' y1='18.5' y2='19.4' gradientUnits='userSpaceOnUse'%3e%3cstop stop-color='%2326FBFF'/%3e%3cstop offset='.6' stop-color='%230BF7F9' stop-opacity='0'/%3e%3c/linearGradient%3e%3c/defs%3e%3cpath fill='url(%23a)' d='M27 64C11 64 5 43 4 39L0 19c-1-5 4-9 9-9 3 0 8 2 8 7 0 1 1 9 4 17 2 9 5 12 7 12 4 0 6-8 8-17 1-6 2-12 5-17C46 2 54 0 60 0c15 0 22 17 22 21 0 7-6 9-8 9-6 0-8-4-9-7-2-3-3-5-5-5h-2c-5 5-6 31-16 40-5 6-11 6-15 6Z'/%3e%3cpath fill='url(%23b)' d='M27 64C11 64 5 43 4 39L0 19c-1-5 4-9 9-9 3 0 8 2 8 7 0 1 1 9 4 17 2 9 5 12 7 12 4 0 6-8 8-17 1-6 2-12 5-17C46 2 54 0 60 0c15 0 22 17 22 21 0 7-6 9-8 9-6 0-8-4-9-7-2-3-3-5-5-5h-2c-5 5-6 31-16 40-5 6-11 6-15 6Z'/%3e%3cpath fill='url(%23c)' d='M27 64C11 64 5 43 4 39L0 19c-1-5 4-9 9-9 3 0 8 2 8 7 0 1 1 9 4 17 2 9 5 12 7 12 4 0 6-8 8-17 1-6 2-12 5-17C46 2 54 0 60 0c15 0 22 17 22 21 0 7-6 9-8 9-6 0-8-4-9-7-2-3-3-5-5-5h-2c-5 5-6 31-16 40-5 6-11 6-15 6Z'/%3e%3cpath fill='url(%23d)' d='M27 64C11 64 5 43 4 39L0 19c-1-5 4-9 9-9 3 0 8 2 8 7 0 1 1 9 4 17 2 9 5 12 7 12 4 0 6-8 8-17 1-6 2-12 5-17C46 2 54 0 60 0c15 0 22 17 22 21 0 7-6 9-8 9-6 0-8-4-9-7-2-3-3-5-5-5h-2c-5 5-6 31-16 40-5 6-11 6-15 6Z'/%3e%3cpath fill='url(%23e)' d='M27 64C11 64 5 43 4 39L0 19c-1-5 4-9 9-9 3 0 8 2 8 7 0 1 1 9 4 17 2 9 5 12 7 12 4 0 6-8 8-17 1-6 2-12 5-17C46 2 54 0 60 0c15 0 22 17 22 21 0 7-6 9-8 9-6 0-8-4-9-7-2-3-3-5-5-5h-2c-5 5-6 31-16 40-5 6-11 6-15 6Z'/%3e%3cpath fill='url(%23f)' d='M27 64C11 64 5 43 4 39L0 19c-1-5 4-9 9-9 3 0 8 2 8 7 0 1 1 9 4 17 2 9 5 12 7 12 4 0 6-8 8-17 1-6 2-12 5-17C46 2 54 0 60 0c15 0 22 17 22 21 0 7-6 9-8 9-6 0-8-4-9-7-2-3-3-5-5-5h-2c-5 5-6 31-16 40-5 6-11 6-15 6Z'/%3e%3cpath fill='url(%23g)' d='M27 64C11 64 5 43 4 39L0 19c-1-5 4-9 9-9 3 0 8 2 8 7 0 1 1 9 4 17 2 9 5 12 7 12 4 0 6-8 8-17 1-6 2-12 5-17C46 2 54 0 60 0c15 0 22 17 22 21 0 7-6 9-8 9-6 0-8-4-9-7-2-3-3-5-5-5h-2c-5 5-6 31-16 40-5 6-11 6-15 6Z'/%3e%3cpath fill='url(%23h)' d='M27 64C11 64 5 43 4 39L0 19c-1-5 4-9 9-9 3 0 8 2 8 7 0 1 1 9 4 17 2 9 5 12 7 12 4 0 6-8 8-17 1-6 2-12 5-17C46 2 54 0 60 0c15 0 22 17 22 21 0 7-6 9-8 9-6 0-8-4-9-7-2-3-3-5-5-5h-2c-5 5-6 31-16 40-5 6-11 6-15 6Z'/%3e%3cpath fill='url(%23i)' d='M27 64C11 64 5 43 4 39L0 19c-1-5 4-9 9-9 3 0 8 2 8 7 0 1 1 9 4 17 2 9 5 12 7 12 4 0 6-8 8-17 1-6 2-12 5-17C46 2 54 0 60 0c15 0 22 17 22 21 0 7-6 9-8 9-6 0-8-4-9-7-2-3-3-5-5-5h-2c-5 5-6 31-16 40-5 6-11 6-15 6Z'/%3e%3cpath fill='url(%23j)' d='M60 0c-6 0-14 2-19 12l-5 17-2 6v28l8-5c10-9 11-35 16-40h2c2 0 3 2 5 5 1 3 3 7 9 7 2 0 8-2 8-9 0-4-7-21-22-21Z'/%3e%3cpath fill='url(%23k)' d='M27 64C11 64 5 43 4 39L0 19c-1-5 4-9 9-9 3 0 8 2 8 7 0 1 1 9 4 17 2 9 5 12 7 12 4 0 6-8 8-17 1-6 2-12 5-17C46 2 54 0 60 0c15 0 22 17 22 21 0 7-6 9-8 9-6 0-8-4-9-7-2-3-3-5-5-5h-2c-5 5-6 31-16 40-5 6-11 6-15 6Z'/%3e%3cpath fill='url(%23l)' d='M27 64C11 64 5 43 4 39L0 19c-1-5 4-9 9-9 3 0 8 2 8 7 0 1 1 9 4 17 2 9 5 12 7 12 4 0 6-8 8-17 1-6 2-12 5-17C46 2 54 0 60 0c15 0 22 17 22 21 0 7-6 9-8 9-6 0-8-4-9-7-2-3-3-5-5-5h-2c-5 5-6 31-16 40-5 6-11 6-15 6Z'/%3e%3cpath fill='url(%23m)' d='M27 64C11 64 5 43 4 39L0 19c-1-5 4-9 9-9 3 0 8 2 8 7 0 1 1 9 4 17 2 9 5 12 7 12 4 0 6-8 8-17 1-6 2-12 5-17C46 2 54 0 60 0c15 0 22 17 22 21 0 7-6 9-8 9-6 0-8-4-9-7-2-3-3-5-5-5h-2c-5 5-6 31-16 40-5 6-11 6-15 6Z'/%3e%3cpath fill='url(%23n)' d='M27 64C11 64 5 43 4 39L0 19c-1-5 4-9 9-9 3 0 8 2 8 7 0 1 1 9 4 17 2 9 5 12 7 12 4 0 6-8 8-17 1-6 2-12 5-17C46 2 54 0 60 0c15 0 22 17 22 21 0 7-6 9-8 9-6 0-8-4-9-7-2-3-3-5-5-5h-2c-5 5-6 31-16 40-5 6-11 6-15 6Z'/%3e%3cpath fill='url(%23o)' d='M27 64C11 64 5 43 4 39L0 19c-1-5 4-9 9-9 3 0 8 2 8 7 0 1 1 9 4 17 2 9 5 12 7 12 4 0 6-8 8-17 1-6 2-12 5-17C46 2 54 0 60 0c15 0 22 17 22 21 0 7-6 9-8 9-6 0-8-4-9-7-2-3-3-5-5-5h-2c-5 5-6 31-16 40-5 6-11 6-15 6Z'/%3e%3cpath fill='%23316AFF' d='M79 10h-2c3 4 5 9 5 11 0 7-6 9-8 9l-5-1-1 4-4 9c-1 3-3 4-5 4-1 0-3-2-5-9l-2-8c-1-6-3-12-6-17C42 3 34 0 28 0S17 3 14 6l-3 4c3 1 6 3 6 7l3 15 3-9 3-4 2-1c1 0 3 0 5 8 3 9 5 24 13 32 3 4 8 6 14 6s11-3 14-6c6-6 9-15 10-19l4-20c1-5-4-9-9-9Z'/%3e%3cpath fill='url(%23p)' d='M79 10h-2c3 4 5 9 5 11 0 7-6 9-8 9l-5-1-1 4-4 9c-1 3-3 4-5 4-1 0-3-2-5-9l-2-8c-1-6-3-12-6-17C42 3 34 0 28 0S17 3 14 6l-3 4c3 1 6 3 6 7l3 15 3-9 3-4 2-1c1 0 3 0 5 8 3 9 5 24 13 32 3 4 8 6 14 6s11-3 14-6c6-6 9-15 10-19l4-20c1-5-4-9-9-9Z'/%3e%3cpath fill='url(%23q)' d='M79 10h-2c3 4 5 9 5 11 0 7-6 9-8 9l-5-1-1 4-4 9c-1 3-3 4-5 4-1 0-3-2-5-9l-2-8c-1-6-3-12-6-17C42 3 34 0 28 0S17 3 14 6l-3 4c3 1 6 3 6 7l3 15 3-9 3-4 2-1c1 0 3 0 5 8 3 9 5 24 13 32 3 4 8 6 14 6s11-3 14-6c6-6 9-15 10-19l4-20c1-5-4-9-9-9Z'/%3e%3cpath fill='url(%23r)' d='M79 10h-2c3 4 5 9 5 11 0 7-6 9-8 9l-5-1-1 4-4 9c-1 3-3 4-5 4-1 0-3-2-5-9l-2-8c-1-6-3-12-6-17C42 3 34 0 28 0S17 3 14 6l-3 4c3 1 6 3 6 7l3 15 3-9 3-4 2-1c1 0 3 0 5 8 3 9 5 24 13 32 3 4 8 6 14 6s11-3 14-6c6-6 9-15 10-19l4-20c1-5-4-9-9-9Z'/%3e%3cpath fill='url(%23s)' d='M79 10h-2c3 4 5 9 5 11 0 7-6 9-8 9l-5-1-1 4-4 9c-1 3-3 4-5 4-1 0-3-2-5-9l-2-8c-1-6-3-12-6-17C42 3 34 0 28 0S17 3 14 6l-3 4c3 1 6 3 6 7l3 15 3-9 3-4 2-1c1 0 3 0 5 8 3 9 5 24 13 32 3 4 8 6 14 6s11-3 14-6c6-6 9-15 10-19l4-20c1-5-4-9-9-9Z'/%3e%3cpath fill='url(%23t)' d='M79 10h-2c3 4 5 9 5 11 0 7-6 9-8 9l-5-1-1 4-4 9c-1 3-3 4-5 4-1 0-3-2-5-9l-2-8c-1-6-3-12-6-17C42 3 34 0 28 0S17 3 14 6l-3 4c3 1 6 3 6 7l3 15 3-9 3-4 2-1c1 0 3 0 5 8 3 9 5 24 13 32 3 4 8 6 14 6s11-3 14-6c6-6 9-15 10-19l4-20c1-5-4-9-9-9Z'/%3e%3cpath fill='url(%23u)' d='M79 10h-2c3 4 5 9 5 11 0 7-6 9-8 9l-5-1-1 4-4 9c-1 3-3 4-5 4-1 0-3-2-5-9l-2-8c-1-6-3-12-6-17C42 3 34 0 28 0S17 3 14 6l-3 4c3 1 6 3 6 7l3 15 3-9 3-4 2-1c1 0 3 0 5 8 3 9 5 24 13 32 3 4 8 6 14 6s11-3 14-6c6-6 9-15 10-19l4-20c1-5-4-9-9-9Z'/%3e%3cpath fill='url(%23v)' d='M79 10h-2c3 4 5 9 5 11 0 7-6 9-8 9l-5-1-1 4-4 9c-1 3-3 4-5 4-1 0-3-2-5-9l-2-8c-1-6-3-12-6-17C42 3 34 0 28 0S17 3 14 6l-3 4c3 1 6 3 6 7l3 15 3-9 3-4 2-1c1 0 3 0 5 8 3 9 5 24 13 32 3 4 8 6 14 6s11-3 14-6c6-6 9-15 10-19l4-20c1-5-4-9-9-9Z'/%3e%3cpath fill='url(%23w)' d='M79 10h-2c3 4 5 9 5 11 0 7-6 9-8 9l-5-1-1 4-4 9c-1 3-3 4-5 4-1 0-3-2-5-9l-2-8c-1-6-3-12-6-17C42 3 34 0 28 0S17 3 14 6l-3 4c3 1 6 3 6 7l3 15 3-9 3-4 2-1c1 0 3 0 5 8 3 9 5 24 13 32 3 4 8 6 14 6s11-3 14-6c6-6 9-15 10-19l4-20c1-5-4-9-9-9Z'/%3e%3cpath fill='url(%23x)' d='M79 10h-2c3 4 5 9 5 11 0 7-6 9-8 9l-5-1-1 4-4 9c-1 3-3 4-5 4-1 0-3-2-5-9l-2-8c-1-6-3-12-6-17C42 3 34 0 28 0S17 3 14 6l-3 4c3 1 6 3 6 7l3 15 3-9 3-4 2-1c1 0 3 0 5 8 3 9 5 24 13 32 3 4 8 6 14 6s11-3 14-6c6-6 9-15 10-19l4-20c1-5-4-9-9-9Z'/%3e%3cpath fill='url(%23y)' d='M79 10h-2c3 4 5 9 5 11 0 7-6 9-8 9l-5-1-1 4-4 9c-1 3-3 4-5 4-1 0-3-2-5-9l-2-8c-1-6-3-12-6-17C42 3 34 0 28 0S17 3 14 6l-3 4c3 1 6 3 6 7l3 15 3-9 3-4 2-1c1 0 3 0 5 8 3 9 5 24 13 32 3 4 8 6 14 6s11-3 14-6c6-6 9-15 10-19l4-20c1-5-4-9-9-9Z'/%3e%3cpath fill='url(%23z)' d='M27 64C11 64 5 43 4 39L0 19c-1-5 4-9 9-9 3 0 8 2 8 7 0 1 1 9 4 17 2 9 5 12 7 12 4 0 6-8 8-17 1-6 2-12 5-17C46 2 54 0 60 0c15 0 22 17 22 21 0 7-6 9-8 9-6 0-8-4-9-7-2-3-3-5-5-5h-2c-5 5-6 31-16 40-5 6-11 6-15 6Z'/%3e%3cpath fill='url(%23A)' d='M27 64C11 64 5 43 4 39L0 19c-1-5 4-9 9-9 3 0 8 2 8 7 0 1 1 9 4 17 2 9 5 12 7 12 4 0 6-8 8-17 1-6 2-12 5-17C46 2 54 0 60 0c15 0 22 17 22 21 0 7-6 9-8 9-6 0-8-4-9-7-2-3-3-5-5-5h-2c-5 5-6 31-16 40-5 6-11 6-15 6Z'/%3e%3cpath fill='url(%23B)' d='M27 64C11 64 5 43 4 39L0 19c-1-5 4-9 9-9 3 0 8 2 8 7 0 1 1 9 4 17 2 9 5 12 7 12 4 0 6-8 8-17 1-6 2-12 5-17C46 2 54 0 60 0c15 0 22 17 22 21 0 7-6 9-8 9-6 0-8-4-9-7-2-3-3-5-5-5h-2c-5 5-6 31-16 40-5 6-11 6-15 6Z'/%3e%3cpath fill='url(%23C)' d='M27 64C11 64 5 43 4 39L0 19c-1-5 4-9 9-9 3 0 8 2 8 7 0 1 1 9 4 17 2 9 5 12 7 12 4 0 6-8 8-17 1-6 2-12 5-17C46 2 54 0 60 0c15 0 22 17 22 21 0 7-6 9-8 9-6 0-8-4-9-7-2-3-3-5-5-5h-2c-5 5-6 31-16 40-5 6-11 6-15 6Z'/%3e%3cpath fill='url(%23D)' d='M27 64C11 64 5 43 4 39L0 19c-1-5 4-9 9-9 3 0 8 2 8 7 0 1 1 9 4 17 2 9 5 12 7 12 4 0 6-8 8-17 1-6 2-12 5-17C46 2 54 0 60 0c15 0 22 17 22 21 0 7-6 9-8 9-6 0-8-4-9-7-2-3-3-5-5-5h-2c-5 5-6 31-16 40-5 6-11 6-15 6Z'/%3e%3c/svg%3e");
  background-size: contain;
  background-repeat: no-repeat;
  ...
  const linkIcons = FeatureGroup.register({ settings: settings$2, onload: onload$8 });
  const features = new Set(['markdownSupport', 'sendHotkey']);
  const messages = FeatureGroup.register({ features });
  ...
  const marqueeStyle = {
    marquee: 'better-moodle_src-style-marquee__marquee',
    marqueeMinWidthPlaceholder: 'better-moodle_src-style-marquee__marquee-min-width-placeholder',
  };
  ...
  const navbarMarquee = FeatureGroup.register({
    settings: new Set([speed]),
    features: new Set(['eventAdvertisements', 'clock', 'christmasCountdown']),
  });
  const style$6 = {
    unseen: 'better-moodle_src-features-nina-__unseen',
    spin: 'better-moodle_src-features-nina-__spin',
  };
    ...
    getAlert(alertId)
      ...
      .then(alert => {
        ...
        alertFooterTextElem.append(
          createElement(
            ...
            LL$6.modal.providedBy({
              provider: `${(senderName ?? senderLongname) ? `${senderName ?? senderLongname} ${LL$6.modal.via()}` : ''} ${getProviderLabel(provider2)}`,
            })
          ),
          createElement('br', null)
        );
        ...
        navigator.locks.request(LOCK_NAME, () => {
          ...
          alertsModalBody
            .querySelector(`.card:has([data-alert="${alert.identifier}"])`)
            ?.classList.remove(style$6.unseen);
        });
      });
  };
      ...
      if (inAppNotifications.value) {
        toast(shortDescription, {
          ...
          subtitle: getHtml(
            createElement(
              'a',
              { href: `https://warnung.bund.de/meldungen/${alertId}/`, dataset: { alert: alertId }, target: '_blank' },
              LL$6.modal.showMore()
            )
          ),
        });
  ...
  const alertsModal = new Modal({
    ...
    title: createElement(
      ...
      null,
      createElement('i', { className: 'icon fa fa-exclamation-triangle fa-fw text-warning' }),
      LL$6.modal.activeWarnings({ municipalty: 'Lübeck' })
    ),
  ...
  const requestAlerts = () =>
    getAlerts()
      ...
      .then(async alertIds => {
        ...
        const alertCache = getCachedActiveAlerts();
        alerts.sort((a2, b) => {
          const seenA = alertCache[a2.identifier].seen;
          const seenB = alertCache[b.identifier].seen;
          const severityA = getAlertInfoAttribute(a2, 'severity');
  ...
  const nina = FeatureGroup.register({
    settings: new Set([
    ...
    get #realContent() {
      return this.#card ?
          createElement(
            ...
            this.#showTitle ? createElement('h5', { className: 'card-title d-inline' }, this.#title) : null,
  ...
  const style$5 = {
    todaySpan: 'better-moodle_src-features-semesterzeiten-__today-span',
    tableToggle: 'better-moodle_src-features-semesterzeiten-__table-toggle',
    progressOverlayBar: 'better-moodle_src-features-semesterzeiten-__progress-overlay-bar',
  };
...
${barSelectors.join(',\n')} {
  ...
  const loadProgressBar = (semester, currentSemester2) => {
    ...
    const stopDates = Array.from(stops.keys()).toSorted((a2, b) => a2.getTime() - b.getTime());
      ...
      .then(([semester, semesterCount]) => {
        ...
        block.setContent(
          createElement(
            Fragment,
            null,
            0 === currentSemester ? createElement('div', { className: 'position-relative' }, todaySpan) : null,
  ...
  blockSetting.onInput(() => void reload$e());
  const semesterzeiten$1 = FeatureGroup.register({
  ...
  const getDishes = dayEl => {
    ...
    dayEl.querySelectorAll('.mensa_menu_detail').forEach(dishEl => {
      ...
      const dish = {
        ...
        co2: {
          stars: Number(dishEl.querySelector('.co2box .co2blatt[data-anz]')?.dataset.anz ?? '0'),
  ...
  const style$4 = {
    foodIcon: 'better-moodle_src-features-speiseplan-__food-icon',
    dishImg: 'better-moodle_src-features-speiseplan-__dish-img',
    table: 'better-moodle_src-features-speiseplan-__table',
  };
  const LL$4 = LLFG('speiseplan');
  const enabled$g = new BooleanSetting('enabled', true).addAlias('general.speiseplan');
      ...
      getDocument(url, 6e5).then(({ lastUpdate, value: doc }) => {
        ...
        const types = new Map(
          Array.from(doc.querySelectorAll('.filterbutton[data-typ="3"]')).map(el => {
            ...
            const dishType = { name: el.textContent?.trim() ?? '', icon: iconPath ? new URL(iconPath, url) : void 0 };
            if ('1' === el.dataset.ex && icon) {
              dishType.name =
                doc.querySelector(`:not(.filterbutton) > img[src*="${iconPath}"]`)?.title ?? dishType.name;
  ...
  const Day = ({ speiseplan: speiseplan2, day, dishes, expanded, co2InfoLink, lang }) => {
    const Dish = ({ dish }) =>
      createElement(
        'tr',
        { dataset: { types: dish.types.values().toArray().join(' ') } },
        createElement(
          'td',
          ...
          dish.allergenes.length ?
            createElement(
              ...
              createElement(
                ...
                '(',
                dish.allergenes.map(a2 => `${a2}: ${speiseplan2.allergenes.get(a2)}`).join(', '),
                ')'
              )
            )
          : '',
          dish.additives.length ?
            createElement(
              ...
              createElement(
                ...
                { className: 'text-muted small' },
                '(',
                dish.additives.map(a2 => `${a2}: ${speiseplan2.additives.get(a2)}`).join(', '),
                ')'
              )
            )
          : ''
        ...
        createElement(
          ...
          ...dish.types.map(t => {
            const dishType = speiseplan2.types.get(t);
            if (!dishType?.icon) return t;
            return createElement('img', {
              className: style$4.dishImg,
  ...
  const getCurrentSpeiseplan = () => {
    ...
    const filtersFieldset = createElement(FieldSet, {
      title: getHtml(
        createElement(
          Fragment,
          null,
          createElement('i', { className: 'fa fa-filter fa-fw mr-1' }),
          LL$4.filters.title()
        )
      ),
      description: LL$4.filters.description(),
    });
    filtersFieldset.id = 'speiseplan-filters-fieldset';
    const createFilters = speiseplan2 => {
      const id = domID(`speiseplan-filters-${crypto.randomUUID()}`);
      const filtersElement = createElement(AutoComplete, {
        id,
        value: GM_getValue('speiseplan.activeFilters', []),
        placeholder: LL$4.filters.placeholder(),
        options: speiseplan2.types
          .entries()
          ...
          .map(([value, { name, icon }]) => ({
            ...
            html: getHtml(
              createElement(
                'span',
                null,
                icon ? createElement('img', { className: style$4.dishImg, src: icon.toString(), alt: name }) : null,
                name
              )
            ),
          }))
      ...
      filtersElement.addEventListener('change', () => {
        GM_setValue('speiseplan.activeFilters', filtersElement.value);
    ...
    const getExpandedDay = () =>
      Number(
        new Date().toDateString() === firstDay?.toDateString() && new Date().getHours() >= currentCanteen().closingHour
      );
    return Promise.all([parse(url), parse(urlNextWeek)])
      .then(([thisWeek, nextWeek]) => {
        ...
        const speiseplan2 = thisWeek;
        speiseplan2.dishes = new Map([...thisWeek.dishes, ...nextWeek.dishes]);
        speiseplan2.allergenes = new Map([...thisWeek.allergenes, ...nextWeek.allergenes]);
        speiseplan2.additives = new Map([...thisWeek.additives, ...nextWeek.additives]);
        speiseplan2.types = new Map([...thisWeek.types, ...nextWeek.types]);
        return speiseplan2;
      })
      .then(speiseplan2 => {
        const fieldsets = speiseplan2.dishes
          .entries()
          .map(([day, dishes], index) =>
            createElement(Day, {
              speiseplan: speiseplan2,
              day,
              dishes,
          ...
          .toArray();
        return [[filtersFieldset, ...fieldsets], createFilters(speiseplan2)];
      });
  };
  const filterStyle = createElement('style', null);
  const updateFilterStyle = (activeFilters = GM_getValue('speiseplan.activeFilters', [])) => {
  ...
  const openSpeiseplan = () => {
    ...
    const modal = new Modal({
      ...
      body: getCurrentSpeiseplan()
        .then(([fieldsets, createFilters]) => {
          ...
          return createElement(Fragment, null, filterStyle, ...Array.from(fieldsets));
        })
    ...
    modal.getBody().then(() => initialCreateFilters?.());
  ...
  enabled$g.onInput(() => void reload$d());
  const speiseplan = FeatureGroup.register({
    settings: new Set([enabled$g, language, canteen]),
    onload: reload$d,
    onunload: reload$d,
  });
  ...
  const openWeatherMap = (lat, lon, apiKey) => {
    ...
    return cachedRequest(url, 3e5, 'json', weather2 => ({
      condition: codeToCondition('openWeatherMap', weather2.weather[0].id),
      temperature: { actual: weather2.main.temp, feel: weather2.main.feels_like },
      wind: { direction: weather2.wind.deg, speed: weather2.wind.speed },
      visibility: weather2.visibility / 1e3,
      humidity: weather2.main.humidity / 100,
      pressure: weather2.main.pressure,
      cloudCover: weather2.clouds.all / 100,
      precipitation: weather2.rain?.['1h'] ?? 0,
      meta: {
        providerURL: 'https://openweathermap.org',
        requestURL: url,
        time: new Date(1e3 * weather2.dt).toISOString(),
      },
    }));
  };
  const units$1 = {
  ...
  const visualCrossing = (city, apiKey) => {
    ...
    return cachedRequest(url, 3e5, 'json', ({ currentConditions: weather2 }) => ({
      condition: codeToCondition('visualCrossing', weather2.icon),
      temperature: { actual: weather2.temp, feel: weather2.feelslike },
      wind: { direction: weather2.winddir, speed: weather2.windspeed },
      visibility: weather2.visibility,
      humidity: weather2.humidity / 100,
      pressure: weather2.pressure,
      cloudCover: weather2.cloudcover / 100,
      precipitation: weather2.precip,
      meta: {
        providerURL: 'https://visualcrossing.com',
        requestURL: url,
        time: new Date(1e3 * weather2.datetimeEpoch).toISOString(),
      },
    }));
  };
  const wttrIn = city => {
    const url = `https://wttr.in/${city}?format=j1&lang`;
    return cachedRequest(url, 3e5, 'json', ({ current_condition: [weather2] }) => ({
      condition: codeToCondition('wttrIn', Number(weather2.weatherCode)),
      temperature: { actual: Number(weather2.temp_C), feel: Number(weather2.FeelsLikeC) },
      wind: { direction: Number(weather2.winddirDegree), speed: Number(weather2.windspeedKmph) },
      visibility: Number(weather2.visibility),
      humidity: Number(weather2.humidity) / 100,
      pressure: Number(weather2.pressure),
      cloudCover: Number(weather2.cloudcover) / 100,
      precipitation: Number(weather2.precipMM),
      meta: {
        providerURL: `https://wttr.in/${city}`,
        requestURL: url,
        time: new Date(`${weather2.localObsDateTime.slice(0, 10)} ${weather2.observation_time} +00:00`).toISOString(),
      },
    }));
  };
  ...
  const enabled$f = new BooleanSetting('enabled', false).addAlias('weatherDisplay.show');
  const tempInNav = new BooleanSetting('tempInNav', true)
    .addAlias('weatherDisplay.showTempInNavbar')
    .disabledIf(enabled$f, '!=', true);
  ...
  const updateWeather = async () => {
    ...
    const { value: weather2, cached } = response ?? { value: void 0, cached: true };
    ...
    const weatherEmoji = getWeatherEmoji(weather2.condition);
    navbarText.textContent = weatherEmoji;
    if (0 === weather2.condition) {
      setTooltipContent(`${weatherEmoji} ${LL$3.conditions[0]()}`);
      return;
    }
    if (tempInNav.value) {
      if (feelLikeTempInNav.value) {
        navbarText.textContent += ` ${stringify(weather2.temperature.feel, 'temperature', currentUnit())}`;
      } else navbarText.textContent += ` ${stringify(weather2.temperature.actual, 'temperature', currentUnit())}`;
    }
    const date = new Date(weather2.meta.time);
    const weatherSummary = `${weatherEmoji} ${LL$3.conditions[weather2.condition]()}`;
    setTooltipContent(
      createElement(
        Fragment,
        null,
        ...
        createElement('br', null),
        '🌡️: ',
        stringify(weather2.temperature.actual, 'temperature', currentUnit()),
        ' (',
        stringify(weather2.temperature.feel, 'temperature', currentUnit()),
        ')',
        createElement('br', null),
        '🪁: ',
        stringify(weather2.wind.speed, 'speed', currentUnit()),
        ' (',
        windDegreesToDirection(weather2.wind.direction),
        ')',
        createElement('br', null),
        '💦: ',
        stringify(weather2.precipitation, 'distanceMm', currentUnit()),
        createElement('br', null),
        createElement('br', null),
    ...
    detailsModalTBody.replaceChildren(
      ...
      createElement(
        ...
        createElement('td', null, stringify(weather2.visibility, 'distanceKm', currentUnit()))
      ),
      createElement(
        'tr',
        null,
        createElement('th', null, LL$3.modal.humidity()),
        createElement('td', null, percent(weather2.humidity))
      ),
      createElement(
        'tr',
        null,
        createElement('th', null, LL$3.modal.pressure()),
        createElement('td', null, stringify(weather2.pressure, 'pressure', currentUnit()))
      ),
      createElement(
        'tr',
        null,
        createElement('th', null, LL$3.modal.cloudCover()),
        createElement('td', null, percent(weather2.cloudCover))
      ),
      createElement(
        'tr',
        null,
        createElement('th', null, LL$3.modal.precipitation()),
        createElement('td', null, stringify(weather2.precipitation, 'distanceMm', currentUnit()))
      )
    );
    detailsModalFooter.replaceChildren(
      createElement(
        ...
        LL$3.modal.source(),
        ': ',
        createElement('a', { href: weather2.meta.providerURL, target: '_blank' }, LL$3.providers[provider.value]()),
        ' ⋅ ',
        timeToString(date, false),
        ' ⋅ ',
        createElement('a', { href: weather2.meta.requestURL, target: '_blank' }, LL$3.modal.raw())
      )
    );
  };
  const reload$c = () => {
  ...
  const settings$1 = new Set([enabled$f, tempInNav, feelLikeTempInNav, units, provider, ...apiKeys.values()]);
  settings$1.forEach(setting => setting.onChange(reload$c));
  const weather = FeatureGroup.register({ settings: settings$1, onload: reload$c, onunload: reload$c });
  importCSS(
    '@media (min-width: 840px) {\n  .block-myoverview .card-grid[data-region=card-deck] > .col {\n    --width: calc(100% / var(--boxes-per-row, 4));\n    min-width: var(--width) !important;\n    width: var(--width) !important;\n    max-width: var(--width) !important;\n  }\n}'
  );
  class Feature {
    static register({ settings: settings2, loadPrerequisites = null, ...methods }) {
      return class Feature extends this {
        constructor(id, group) {
          super(id, group, settings2 ?? new Set(), methods, loadPrerequisites);
        }
      };
    }
    #id;
    ...
    #loadPrerequisites;
    #loaded = false;
    constructor(id, group, settings2, methods, loadPrerequisites) {
      this.#id = id;
      this.#group = group;
      this.#settings = settings2;
      this.#onload = methods.onload;
    ...
    load(groupPrerequisites) {
      if (this.#loaded) throw Error(`Feature ${this.id} already loaded.`);
      featurePrerequisitesReady(this.#loadPrerequisites ?? groupPrerequisites ?? null)
        .then(() => {
          this.#loaded = true;
          this.#onload?.();
        })
  ...
  const amount = new SliderSetting('amount', 4, { min: 1, max: 10, step: 1, labels: 10 })
    ...
    .onInput(setAmount);
  const courses_cardsPerRow = Feature.register({ settings: new Set([amount]), onload: () => setAmount() });
  const enabled$e = new BooleanSetting('enabled', true).addAlias('courses.grades');
  const newTab = new BooleanSetting('newTab', false)
    .addAlias('courses.gradesNewTab')
    .disabledIf(enabled$e, '==', false);
  let gradesLink;
  newTab.onInput(() => {
    if (newTab.value) {
  ...
  enabled$e.onInput(() => void reload$b());
  const courses_grades = Feature.register({
    settings: new Set([enabled$e, newTab]),
    onload: reload$b,
    onunload: reload$b,
  });
  const hideStyleEl = d('.course-hint-selfenrol.alert.alert-info {\n  display: none !important;\n}');
  ...
  hide.onInput(reload$a);
  const courses_hideSelfEnrolHint = Feature.register({
    settings: new Set([hide]),
    onload: reload$a,
    onunload: reload$a,
  });
  const maxWidthStyleEl = d(
    '#region-main img:not(.activityicon):not(.icon):not(.img-fluid):not(.draghome):not(.droppreview) {\n  max-width: 100%;\n}'
  );
  const zoomStyle = {
    zoomEnabled: 'better-moodle_src-features-courses-images-zoom__zoom-enabled',
    overlay: 'better-moodle_src-features-courses-images-zoom__overlay',
  };
  ...
  const courses_images = Feature.register({
  ...
  const style$3 = { desktop: 'better-moodle_src-features-courses-navbarDropdown-__desktop' };
  ...
  const enabled$d = new BooleanSetting('enabled', true).addAlias('myCourses.navbarDropdown').requireReload();
    ...
    Promise.all([
      ...
      .then(([filter2, [templates, myCourses]]) => {
        ...
        return myCourses
          ...
          .then(({ courses: courses2 }) => ({ courses: courses2, templates }));
      })
      .then(({ courses: courses2, templates }) => {
        if (favouriteCoursesAtTop$1.value) courses2.sort((a2, b) => Number(b.isfavourite) - Number(a2.isfavourite));
        const courseItems = courses2.map(course => ({
          isactive: false,
          url: course.viewurl,
...
${course.fullname}`,
          text: getHtml(
            createElement(
              Fragment,
              null,
              course.isfavourite ? createElement('i', { className: 'icon fa fa-star fa-fw' }) : null,
              course.shortname ? createElement('strong', null, course.shortname) : null,
              ' ',
        ...
        const mobile = renderCustomTemplate(
          ...
          '\r{{#includeTrigger}}\r<a id="drop-down-{{sort}}" href="#" class="list-group-item list-group-item-action icons-collapse-expand collapsed d-flex" data-toggle="collapse" data-target="#drop-down-menu-{{sort}}" aria-expanded="false" aria-controls="drop-down-menu-{{sort}}">\r  {{{text}}}\r  <span class="ml-auto expanded-icon icon-no-margin mx-2">\r  {{#pix}} t/expanded, core {{/pix}}\r  <span class="sr-only">\r  {{#str}} collapse, core {{/str}}\r  </span>\r  </span>\r  <span class="ml-auto collapsed-icon icon-no-margin mx-2">\r  {{#pix}} t/collapsed, core {{/pix}}\r  <span class="sr-only">\r  {{#str}} expand, core {{/str}}\r  </span>\r  </span>\r</a>\r{{/includeTrigger}}\r<div class="collapse {{#isopen}}show {{/isopen}}list-group-item p-0 border-0" role="menu" id="drop-down-menu-{{sort}}" aria-labelledby="drop-down-{{sort}}">\r  {{#children}}\r  {{^divider}}\r  <a href="{{{url}}}" class="ps-5 {{^isactive}}bg-light{{/isactive}}{{#isactive}}active{{/isactive}} list-group-item list-group-item-action">{{{text}}}</a>\r  {{/divider}}\r  {{/children}}\r</div>\r',
          {
  ...
  const courses_navbarDropdown = Feature.register({
    settings: new Set([enabled$d, filter, favouriteCoursesAtTop$1]),
    onload: async () => {
      if (!enabled$d.value) return;
      await ready();
  ...
  const enabled$c = new BooleanSetting('enabled', true).addAlias('general.noDownload');
  ...
  enabled$c.onInput(() => void reload$9());
  const courses_noDownload = Feature.register({ settings: new Set([enabled$c]), onload: reload$9, onunload: reload$9 });
  const enabled$b = new BooleanSetting('enabled', true).addAlias('general.quickRoleChange');
  let menuItem;
  let menuItemLink;
  let submenu;
      ...
      : getAvailableRoles()
          .then(roleItems =>
            renderCustomTemplate(
              ...
              '<div id="carousel-item-{{id}}" role="menu" class="carousel-item submenu" tabindex="-1" aria-label="{{title}}">\r  <div class="d-flex flex-column h-100">\r  <div class="header">\r  <button type="button" class="btn btn-icon carousel-navigation-link text-decoration-none text-body" data-carousel-target-id="carousel-item-main" aria-label="{{#str}}usermenugoback{{/str}}">\r  <span class="dir-rtl-hide">{{#pix}}i/arrow-left{{/pix}}</span>\r  <span class="dir-ltr-hide">{{#pix}}i/arrow-right{{/pix}}</span>\r  </button>\r  <span class="ps-2" id="carousel-item-title-{{id}}">{{title}}</span>\r  </div>\r  <div class="dropdown-divider"></div>\r  <div class="items h-100 overflow-auto" role="menu" aria-labelledby="carousel-item-title-{{id}}">\r  {{>core/user_action_menu_submenu_items}}\r  </div>\r  </div>\r</div>\r',
              {
  ...
  const courses_quickRoleChange = Feature.register({
    settings: new Set([enabled$b]),
    onload: reload$8,
    onunload: reload$8,
  });
  const enabled$a = new BooleanSetting('enabled', true);
  ...
  const courses_sectionCourseIndex = Feature.register({
    settings: new Set([enabled$a]),
    onload: reload$7,
    onunload: reload$7,
  });
  const enabled$9 = new BooleanSetting('enabled', true).addAlias('courses.collapseAll');
  const reload$6 = async () => {
    if (!M.cfg.courseId || 1 === M.cfg.courseId) return;
    const drawer2 = await ready().then(() => document.getElementById('theme_boost-drawers-courseindex'));
    if (!drawer2) return;
    const listener2 = event => {
      const target = event.target;
      if (!(target instanceof HTMLElement) && !(target instanceof SVGElement)) return;
      const collapseIcon = target.closest('.courseindex-section-title .icons-collapse-expand');
      if (!collapseIcon) return;
      event.preventDefault();
      drawer2
        .querySelectorAll(
          '.courseindex-section-title .icons-collapse-expand' +
            (collapseIcon.classList.contains('collapsed') ? ':not(.collapsed)' : '.collapsed')
        )
        .forEach(collapseIcon2 => collapseIcon2.click());
      collapseIcon.focus();
    };
    if (enabled$9.value) drawer2.addEventListener('dblclick', listener2);
    else drawer2.removeEventListener('dblclick', listener2);
  };
  enabled$9.onInput(() => void reload$6());
  const courses_sidebarCollapseAll = Feature.register({
    settings: new Set([enabled$9]),
    onload: reload$6,
    onunload: reload$6,
  });
  var Side = (Side2 => {
  ...
  class Drawer {
    ...
    setHeading(heading) {
      if (this.#instance) this.querySelector('.drawerheadercontent')?.replaceChildren(heading);
      else {
        this.#throwOnRendered();
    ...
    setContent(content) {
      if (this.#instance) this.querySelector('.drawercontent')?.replaceChildren(content);
      else {
        this.#throwOnRendered();
        this.#content = content;
      }
    ...
    querySelector(selector) {
      return this.#instance?.drawerNode.querySelector(selector);
    }
    ...
    #render() {
      ...
      return renderCustomTemplate(
        'drawer',
        '{{<theme_boost/drawer}}\r  {{$drawerclasses}}{{{classes}}}{{/drawerclasses}}\r  {{$id}}{{{id}}}{{/id}}\r  {{$drawerstate}}{{{state}}}{{/drawerstate}}\r  {{$tooltipplacement}}{{{tooltip}}}{{/tooltipplacement}}\r  {{$drawercontent}}{{{content}}}{{/drawercontent}}\r  \r  \r  {{$drawerheadercontent}}{{{heading}}}{{/drawerheadercontent}}\r{{/theme_boost/drawer}}\r',
        {
    ...
    async create() {
      ...
      this.addEventListener(Drawers.eventTypes.drawerShown, () => {
        ...
        this.querySelector('.drawerheadercontent')?.classList.remove('hidden');
        doPubsub(true);
      });
  ...
  const style$2 = {
    coursesSidebarFilterMenu: 'better-moodle_src-features-dashboard-layout__courses_sidebar-filter-menu',
  };
  ...
  const getCourseBlocks = () =>
    Promise.all([
      ...
      .then(({ courses: courses2 }) => {
        if (!courses2.length) return [];
        if (favouriteCoursesAtTop.value) courses2.sort((a2, b) => Number(b.isfavourite) - Number(a2.isfavourite));
        const context = {
          courses: courses2.map(course => ({
            ...course,
            searchText: `${course.shortname} ${course.fullname}`.toLowerCase(),
          })),
        };
        return renderCustomTemplateAsElements(
          'dashboard/layout/course_block',
          '{{#courses}}\r  <div\r  class="card block mb-3"\r  data-search-text="{{searchText}}"\r  data-course-id="{{id}}"\r  >\r  <div class="card-body p-3">\r  <div class="float-right">\r  {{>block_myoverview/course-action-menu}}\r  </div>\r  <a href={{viewurl}}>\r  <i class="icon fa fa-star fa-fw {{^isfavourite}}hidden{{/isfavourite}}"></i>\r  {{#shortname}}\r  <strong>{{{shortname}}}</strong>\r  <br/>\r  {{/shortname}}\r  </a>\r  <small>{{{fullname}}}</small>\r  </div>\r  </div>\r{{/courses}}\r',
          context
        ).then(els => Array.from(els));
      });
  const setCourseHiddenState = (courseId, state) =>
    requirePromise(['core_user/repository', 'core/notification'])
      .then(([{ setUserPreference }, Notification]) =>
        setUserPreference(`block_myoverview_hidden_course_${courseId}`, state || null).catch(Notification.exception)
      )
      .then(() => drawer.querySelector(`.block.card[data-course-id="${courseId}"]`)?.remove());
  const setCourseFavouriteState = (courseId, state) => {
    const addAction = drawer.querySelector(`[data-action="add-favourite"][data-course-id="${courseId}"]`);
    const removeAction = drawer.querySelector(`[data-action="remove-favourite"][data-course-id="${courseId}"]`);
    const favouriteIcon = drawer.querySelector(`.block.card[data-course-id="${courseId}"] .fa-star`);
    requirePromise(['block_myoverview/repository', 'core/notification']).then(
      ([{ setFavouriteCourses }, Notification]) =>
        setFavouriteCourses({ courses: [{ id: courseId, favourite: state }] })
          .then(result => {
            if (result.warnings.length) throw new Error('Changing favourite state failed');
  ...
  const initCourseSidebar = async () => {
    ...
    onActiveFilterChanged(() => {
      if ('_sync' === courseFilter) updateDrawerContent();
    });
    ...
    drawer.addEventListener('click', e => {
      const target = e.target;
      if (!(target instanceof Element)) return;
      const actionEl = target.closest('[data-action][data-course-id]');
      if (!actionEl) return;
      const action = actionEl.dataset.action;
      const courseId = Number(actionEl.dataset.courseId);
      if (!action || !courseId || Number.isNaN(courseId)) return;
      e.preventDefault();
      if ('hide-course' === action) setCourseHiddenState(courseId, true);
      else if ('show-course' === action) setCourseHiddenState(courseId, false);
      else if ('add-favourite' === action) setCourseFavouriteState(courseId, true);
      else if ('remove-favourite' === action) setCourseFavouriteState(courseId, false);
    });
  };
  ...
  const dashboard_layout = Feature.register({
    settings,
    onload: async () => {
      ...
      if (timelineSidebarEnabled.value && true) {
        ...
        new Drawer('dashboard-timeline')
          ...
          .create()
          .then(drawer2 =>
            drawer2.setContent(createElement(Fragment, null, ...Array.from(document.querySelectorAll(selector))))
          );
      }
    },
  });
  ...
  const general_externalLinks = Feature.register({
    settings: new Set([enabled$8]),
    onload: reload$5,
    onunload: reload$5,
  });
  ...
  const general_fullWidth = Feature.register({
    settings: new Set([enabled$7]),
    onload: onload$3,
    onunload: () => void setFullWidth(false),
  });
  const styles = {
    eyes: 'better-moodle_src-features-general-googlyEyes__eyes',
    eye: 'better-moodle_src-features-general-googlyEyes__eye',
    pupil: 'better-moodle_src-features-general-googlyEyes__pupil',
  };
  ...
  const general_googlyEyes = Feature.register({
    settings: new Set([enabled$6]),
    onload: updateEyesStatus,
    onunload: updateEyesStatus,
  });
  const leftStyle = { pulled: 'better-moodle_src-features-general-leftSecondaryNav__pulled' };
  ...
  const general_leftSecondaryNav = Feature.register({
    settings: new Set([enabled$5]),
    onload: onload$2,
    onunload: () => void setPullLeft(false),
  });
  const style$1 = {
    prideLogo: 'better-moodle_src-features-general-prideLogo__pride-logo',
    rotation180Deg: 'better-moodle_src-features-general-prideLogo__rotation-180deg',
    flagRainbow: 'better-moodle_src-features-general-prideLogo__flag-rainbow',
    flagAgender: 'better-moodle_src-features-general-prideLogo__flag-agender',
    flagAro: 'better-moodle_src-features-general-prideLogo__flag-aro',
    flagAce: 'better-moodle_src-features-general-prideLogo__flag-ace',
    flagAroace: 'better-moodle_src-features-general-prideLogo__flag-aroace',
    flagBi: 'better-moodle_src-features-general-prideLogo__flag-bi',
    flagGenderfluid: 'better-moodle_src-features-general-prideLogo__flag-genderfluid',
    flagLesbian: 'better-moodle_src-features-general-prideLogo__flag-lesbian',
    flagEnby: 'better-moodle_src-features-general-prideLogo__flag-enby',
    flagPan: 'better-moodle_src-features-general-prideLogo__flag-pan',
    flagGay: 'better-moodle_src-features-general-prideLogo__flag-gay',
    flagTrans: 'better-moodle_src-features-general-prideLogo__flag-trans',
    flagIntersex: 'better-moodle_src-features-general-prideLogo__flag-intersex',
    rotation135Deg: 'better-moodle_src-features-general-prideLogo__rotation-135deg',
  };
  ...
  const general_prideLogo = Feature.register({
  ...
  const general_truncatedTexts = Feature.register({
    settings: new Set([enabled$4]),
    onload: reload$4,
    onunload: reload$4,
  });
...
${mathJaxed}`,
  ...
  const messages_markdownSupport = Feature.register({
  ...
  const messages_sendHotkey = Feature.register({ settings: new Set([hotkey]), onload: reload$2, onunload: reload$2 });
  ...
  const short = new BooleanSetting('short', false).addTag('fun').disabledIf(enabled$2, '!=', true);
  ...
  const updateCountdown = () => {
    ...
    const text = short.value ? LL$1.short({ days: daysTillThen }) : LL$1.remaining({ days: daysTillThen });
    countdownSpan.innerHTML = countdownSpanClone.innerHTML = mdToHtml(text, void 0, void 0, false);
    marquee.recalculate();
  };
  const reload$1 = () => {
    ...
    } else marquee.remove(countdownSpan);
  };
  enabled$2.onInput(reload$1);
  short.onInput(reload$1);
  const navbarMarquee_christmasCountdown = Feature.register({
    settings: new Set([enabled$2, short]),
    onload: reload$1,
    onunload: reload$1,
  });
  ...
  const navbarMarquee_clock = Feature.register({
  ...
  const style = {
    eventAdvertisement: 'better-moodle_src-features-navbarMarquee-eventAdvertisements__event-advertisement',
  };
    ...
    if (enabled.value) {
      ...
      events2.forEach(event => {
        if (new Date(event.start).getTime() <= Date.now() + noticeTimeMs) {
          ...
          marquee.add(eventSpan)[0][1].addEventListener('click', clickListener);
        }
      });
    } else removeAll();
  };
  ...
  const featureGroupImports = {
    ...
    navbarMarquee,
    nina,
    semesterzeiten: semesterzeiten$1,
    speiseplan,
    weather,
  };
  const featureImports = {
    courses_cardsPerRow,
    courses_grades,
    courses_hideSelfEnrolHint,
    courses_images,
    courses_navbarDropdown,
    courses_noDownload,
    courses_quickRoleChange,
    courses_sectionCourseIndex,
    courses_sidebarCollapseAll,
    dashboard_layout,
    general_externalLinks,
    general_fullWidth,
    general_googlyEyes,
    general_leftSecondaryNav,
    general_prideLogo,
    general_truncatedTexts,
    messages_markdownSupport,
    messages_sendHotkey,
    navbarMarquee_christmasCountdown,
    navbarMarquee_clock,
    navbarMarquee_eventAdvertisements,
  };
  const initFeature = (group, featureId) => {
    const Feature2 = featureImports[`${group.id}_${featureId}`];
    if (!Feature2) return;
    return new Feature2(featureId, group);
  };
  const featureGroups$1 = new Map();
  Object.entries(featureGroupImports).forEach(([groupId, FeatureGroup2]) => {
  ...
  const latestVersionEl = createElement('code', null);
  const isExtension = 'Extension' === GM_info.scriptHandler;
  const SupportWrapper = createElement(
    ...
    createElement(
      'div',
      { className: 'd-flex flex-row flex-lg-column justify-content-center align-items-end' },
      isExtension ?
        createElement(
          'span',
          null,
          LL$a.settings.modal.version(),
          ':',
          ' ',
  ...
  const checkForUpdates = () => {
    if ('Extension' === GM_info.scriptHandler) {
    ...
    importInput.addEventListener('change', () => {
      ...
      reader.addEventListener('load', () => {
        ...
        Object.entries(config)
          .toSorted(([a2], [b]) => a2.localeCompare(b))
...
#${settingsStyle.settingsForm} fieldset:not(:has(.fitem[data-search*="${CSS.escape(search)}" i])) {
  ...
  const settingsModal = new Modal({
    ...
    .onSave(event => {
      ...
      toast(LL$a.settings.saved(), { type: 'success', autohide: true, closeButton: true });
  ...
  if (
    !new RegExp(
      'Edge?\\/(14[1-9]|1[5-9]\\d|[2-9]\\d\\d|\\d{4,})\\.\\d+(\\.\\d+|)|Firefox\\/(14[4-9]|1[5-9]\\d|[2-9]\\d\\d|\\d{4,})\\.\\d+(\\.\\d+|)|Chrom(ium|e)\\/(14[1-9]|1[5-9]\\d|[2-9]\\d\\d|\\d{4,})\\.\\d+(\\.\\d+|)|Chrome.+OPR\\/(12[2-9]|1[3-9]\\d|[2-9]\\d\\d|\\d{4,})\\.\\d+\\.\\d+|Android.+Firefox\\/(14[7-9]|1[5-9]\\d|[2-9]\\d\\d|\\d{4,})\\.\\d+(\\.\\d+|)',
      ''
